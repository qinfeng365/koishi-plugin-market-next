...
async function resolveRegistryEndpoint(configured, cwd, readRegistry = import_get_registry.default) {
...
function setupConsoleListeners(ctx, config, dataStore, marketSnapshotTransport) {
  ...
  ctx.console.addListener("market/package-history", async (name2, limit) => {
