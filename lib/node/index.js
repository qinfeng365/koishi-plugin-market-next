...
var MarketDataStore = class extends import_console2.DataService {
  ...
  async write() {
    try {
      ...
      await import_fs.promises.writeFile(tempFile, JSON.stringify(this.data, null, 2));
...
var Config = import_koishi5.Schema.object({
  ...
  marketLayout: import_koishi5.Schema.union([
    import_koishi5.Schema.const("grid").description("\u7F51\u683C"),
    import_koishi5.Schema.const("list").description("\u5217\u8868")
