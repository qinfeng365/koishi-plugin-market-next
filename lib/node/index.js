...
var require_schema_zh_CN = __commonJS({
  "src/node/locales/schema.zh-CN.yml"(exports2, module2) {
    module2.exports = { registry: { $description: "\u63D2\u4EF6\u6E90\u8BBE\u7F6E", endpoint: "\u63D2\u4EF6\u7684\u4E0B\u8F7D\u6E90\u3002\u9ED8\u8BA4\u8DDF\u968F\u5F53\u524D\u9879\u76EE\u7684 npm config\u3002", timeout: "\u83B7\u53D6\u63D2\u4EF6\u6570\u636E\u7684\u8D85\u65F6\u65F6\u95F4\u3002", autoRoute: "\u5F53\u524D\u4E0B\u8F7D\u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528 npm \u6E90\u3002", retry: "\u6BCF\u4E2A npm \u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u540E\u7684\u91CD\u8BD5\u6B21\u6570\u3002", concurrency: "\u6279\u91CF\u83B7\u53D6\u4F9D\u8D56\u7248\u672C\u65F6\u7684\u6700\u5927\u5E76\u53D1\u6570\u3002" }, search: { $description: "\u641C\u7D22\u8BBE\u7F6E", endpoint: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u7F51\u5740\u3002\u9ED8\u8BA4\u4F7F\u7528 t4wefan \u955C\u50CF\u3002", timeout: "\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u8D85\u65F6\u65F6\u95F4\u3002", proxyAgent: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u4EE3\u7406\u3002", autoRoute: "\u5F53\u524D\u5E02\u573A\u6E90\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528\u5E02\u573A\u6E90\u3002", logLevel: "\u63D2\u4EF6\u5E02\u573A\u8C03\u8BD5\u65E5\u5FD7\u7EA7\u522B\u3002silent \u5173\u95ED\u65E5\u5FD7\uFF0Cdebug \u8F93\u51FA\u6700\u8BE6\u7EC6\u3002" }, frontendMode: "\u524D\u7AEF\u663E\u793A\u6A21\u5F0F\u3002\u6027\u80FD\u6A21\u5F0F\u4FDD\u6301\u4F4E\u52A8\u6548\uFF1B\u7CBE\u81F4\u6A21\u5F0F\u542F\u7528\u66F4\u7EC6\u817B\u7684\u52A8\u6548\u548C\u9AD8\u7EA7\u6837\u5F0F\u3002", depsLayout: "\u4F9D\u8D56\u7BA1\u7406\u9875\u5E03\u5C40\u3002\u7F51\u683C\u6A21\u5F0F\u591A\u5217\u5C55\u793A\uFF1B\u5217\u8868\u6A21\u5F0F\u5355\u5217\u5BBD\u5361\u7247\uFF0C\u4FE1\u606F\u66F4\u5BC6\u96C6\u3002", marketLayout: "\u63D2\u4EF6\u5E02\u573A\u9875\u5E03\u5C40\u3002\u7F51\u683C\u6A21\u5F0F\u591A\u5217\u5361\u7247\uFF1B\u5217\u8868\u6A21\u5F0F\u5355\u5217\u7D27\u51D1\u884C\u3002", chatlunaTool: "\u542F\u7528 ChatLuna \u63D2\u4EF6\u5E02\u573A\u67E5\u8BE2\u5DE5\u5177\u3002\u542F\u7528\u540E\uFF0C\u82E5\u5F53\u524D Koishi \u540C\u65F6\u5B89\u88C5\u4E86 ChatLuna\uFF0C\u4F1A\u6CE8\u518C\u53EA\u8BFB\u5DE5\u5177 koishi_plugin_market_search\u3002" };
  }
});
...
var Installer = class extends import_koishi.Service {
  ...
  raceEndpoints(name2, endpoints, serial, onAttempt) {
    ...
    if (endpoints.length === 1 || this.config.autoRoute === false) {
      ...
      return this.fetchRegistryEndpoint(name2, endpoints[0], serial).then((r) => {
