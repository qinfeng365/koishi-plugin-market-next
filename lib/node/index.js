...
var require_message_zh_CN = __commonJS({
  "src/node/locales/message.zh-CN.yml"(exports2, module2) {
    module2.exports = { "commands.plugin": { description: "\u63D2\u4EF6\u7BA1\u7406" }, "commands.plugin.install": { description: "\u5B89\u88C5\u63D2\u4EF6", messages: { "expect-name": "\u8BF7\u8F93\u5165\u63D2\u4EF6\u540D\u3002", "already-installed": "\u8BE5\u63D2\u4EF6\u5DF2\u5B89\u88C5\u3002", "not-found": "\u672A\u627E\u5230\u8BE5\u63D2\u4EF6\u3002", success: "\u5B89\u88C5\u6210\u529F\uFF01" } }, "commands.plugin.uninstall": { description: "\u5378\u8F7D\u63D2\u4EF6", messages: { "expect-name": "\u8BF7\u8F93\u5165\u63D2\u4EF6\u540D\u3002", "not-installed": "\u8BE5\u63D2\u4EF6\u672A\u5B89\u88C5\u3002", success: "\u5378\u8F7D\u6210\u529F\uFF01" } }, "commands.plugin.upgrade": { description: "\u5347\u7EA7\u63D2\u4EF6", options: { self: "\u5347\u7EA7 Koishi \u672C\u4F53", force: "\u5FFD\u7565\u66F4\u65B0\u5C4F\u853D\u89C4\u5219\u5E76\u5F3A\u5236\u68C0\u67E5" }, messages: { "all-updated": "\u6240\u6709\u63D2\u4EF6\u5DF2\u662F\u6700\u65B0\u7248\u672C\u3002", available: "\u6709\u53EF\u7528\u7684\u4F9D\u8D56\u66F4\u65B0\uFF1A", prompt: "\u8F93\u5165\u300CY\u300D\u5347\u7EA7\u5168\u90E8\u4F9D\u8D56\uFF0C\u8F93\u5165\u300CN\u300D\u53D6\u6D88\u64CD\u4F5C\u3002", cancelled: "\u5DF2\u53D6\u6D88\u64CD\u4F5C\u3002", failed: "\u5347\u7EA7\u5931\u8D25\uFF0C\u5305\u7BA1\u7406\u5668\u9000\u51FA\u7801\u4E3A {0}\u3002", success: "\u5347\u7EA7\u6210\u529F\uFF01" } }, "commands.plugin.clear-avatar-cache": { description: "\u6E05\u7406 market-next \u5934\u50CF\u7F13\u5B58", messages: { success: "\u5DF2\u6E05\u7406\u5934\u50CF\u7F13\u5B58\uFF1A\u5185\u5B58 {0} \u6761\uFF0C\u78C1\u76D8 {1} \u4E2A\u6587\u4EF6\u3002" } } };
  }
});

// src/node/locales/message.en-US.yml
var require_message_en_US = __commonJS({
  "src/node/locales/message.en-US.yml"(exports2, module2) {
    module2.exports = { "commands.plugin": { description: "Plugin management" }, "commands.plugin.install": { description: "Install Plugins", messages: { "expect-name": "Please enter a plugin name.", "already-installed": "This plugin is already installed.", "not-found": "Plugin not found.", success: "Installation Successful!" } }, "commands.plugin.uninstall": { description: "Uninstall plugin", messages: { "expect-name": "Please enter a plugin name.", "not-installed": "This plugin is not installed.", success: "Uninstalled successfully!" } }, "commands.plugin.upgrade": { description: "Upgrade Plugin", options: { self: "Upgrade Koishi core", force: "Ignore update rules and force an update check" }, messages: { "all-updated": "All plugins are already up to date.", available: "Available dependency updates:", prompt: "Enter Y to upgrade all dependencies, or N to cancel.", cancelled: "Operation canceled.", failed: "Upgrade failed with package manager exit code {0}.", success: "Upgrade Successful!" } }, "commands.plugin.clear-avatar-cache": { description: "Clear market-next avatar cache", messages: { success: "Cleared avatar cache: {0} memory entries, {1} disk files." } } };
  }
});
...
var require_schema_zh_CN = __commonJS({
  "src/node/locales/schema.zh-CN.yml"(exports2, module2) {
    module2.exports = { registry: { $description: "\u63D2\u4EF6\u6E90\u8BBE\u7F6E", endpoint: "\u63D2\u4EF6\u7684\u4E0B\u8F7D\u6E90\u3002\u9ED8\u8BA4\u8DDF\u968F\u5F53\u524D\u9879\u76EE\u7684 npm config\u3002", timeout: "\u83B7\u53D6\u63D2\u4EF6\u6570\u636E\u7684\u8D85\u65F6\u65F6\u95F4\u3002", autoRoute: "\u5F53\u524D\u4E0B\u8F7D\u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528 npm \u6E90\u3002", retry: "\u6BCF\u4E2A npm \u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u540E\u7684\u91CD\u8BD5\u6B21\u6570\u3002", concurrency: "\u6279\u91CF\u83B7\u53D6\u4F9D\u8D56\u7248\u672C\u65F6\u7684\u6700\u5927\u5E76\u53D1\u6570\u3002", installLogRetentionHours: "\u4F9D\u8D56\u5B89\u88C5\u3001\u66F4\u65B0\u4E0E\u5378\u8F7D\u64CD\u4F5C\u65E5\u5FD7\u4FDD\u7559\u591A\u5C11\u5C0F\u65F6\uFF0C\u9ED8\u8BA4 72 \u5C0F\u65F6\u3002" }, search: { $description: "\u641C\u7D22\u8BBE\u7F6E", endpoint: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u7F51\u5740\u3002\u9ED8\u8BA4\u4F7F\u7528 t4wefan \u955C\u50CF\u3002", timeout: "\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u8D85\u65F6\u65F6\u95F4\u3002", proxyAgent: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u4EE3\u7406\u3002", autoRoute: "\u5F53\u524D\u5E02\u573A\u6E90\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528\u5E02\u573A\u6E90\u3002", logLevel: "\u63D2\u4EF6\u5E02\u573A\u8C03\u8BD5\u65E5\u5FD7\u7EA7\u522B\u3002silent \u5173\u95ED\u65E5\u5FD7\uFF0Cdebug \u8F93\u51FA\u6700\u8BE6\u7EC6\u3002" }, marketSilentFilters: "\u65E7\u7248\u6C38\u4E45\u9759\u9ED8\u8FC7\u6EE4\u3002", idleProbe: "Console \u7A7A\u95F2\u65F6\u81EA\u52A8\u63A2\u6D4B\u4F9D\u8D56\u7248\u672C\u548C\u63D2\u4EF6\u5E02\u573A\u6570\u636E\u3002\u4EC5\u5728\u6CA1\u6709\u6D4F\u89C8\u5668\u63A7\u5236\u53F0\u8FDE\u63A5\u65F6\u8FD0\u884C\uFF0C\u4E0D\u4F1A\u56E0\u4E3A\u5237\u65B0\u9875\u9762\u89E6\u53D1\u3002", idleProbeDelay: "Console \u65E0\u4EBA\u5728\u7EBF\u591A\u4E45\u540E\u5F00\u59CB\u540E\u53F0\u63A2\u6D4B\u3002", idleProbeBootDelay: "Koishi \u542F\u52A8\u6216\u91CD\u8F7D\u540E\uFF0C\u81F3\u5C11\u7B49\u5F85\u591A\u4E45\u624D\u5141\u8BB8\u7A7A\u95F2\u63A2\u6D4B\u3002", idleProbeInterval: "\u4E24\u6B21\u7A7A\u95F2\u540E\u53F0\u63A2\u6D4B\u4E4B\u95F4\u7684\u6700\u5C0F\u95F4\u9694\u3002", bulkMode: "\u6279\u91CF\u64CD\u4F5C\u6A21\u5F0F\u3002\u5F00\u542F\u540E\u5B89\u88C5\u3001\u66F4\u65B0\u3001\u5378\u8F7D\u4F1A\u5148\u6682\u5B58\uFF0C\u70B9\u51FB\u201C\u5E94\u7528\u66F4\u6539\u201D\u540E\u6267\u884C\u3002", removeConfig: { $description: "\u5378\u8F7D\u63D2\u4EF6\u65F6\u662F\u5426\u540C\u65F6\u5220\u9664\u5DF2\u6709\u63D2\u4EF6\u914D\u7F6E\u3002\u672A\u8BBE\u7F6E\u65F6\u6BCF\u6B21\u8BE2\u95EE\u3002", $inner: ["\u6BCF\u6B21\u8BE2\u95EE", "\u59CB\u7EC8\u5220\u9664\u63D2\u4EF6\u914D\u7F6E", "\u6C38\u4E0D\u5220\u9664\u63D2\u4EF6\u914D\u7F6E"] }, updateIgnoredPackages: "\u4E0D\u68C0\u6D4B\u66F4\u65B0\u7684\u4F9D\u8D56\u540D\u3002\u6BCF\u884C\u4E00\u4E2A\u5305\u540D\uFF0C\u4E5F\u53EF\u4EE5\u4F7F\u7528\u9017\u53F7\u3001\u5206\u53F7\u6216\u7A7A\u683C\u5206\u9694\u3002", updateIgnoreDuration: "\u70B9\u51FB\u201C\u5FFD\u7565\u6B64\u6B21\u66F4\u65B0\u201D\u540E\u7684\u9ED8\u8BA4\u5FFD\u7565\u65F6\u957F\u30020 \u8868\u793A\u4E0D\u6309\u65F6\u95F4\u8FC7\u671F\u3002", updateIgnoreVersions: "\u70B9\u51FB\u201C\u5FFD\u7565\u6B64\u6B21\u66F4\u65B0\u201D\u540E\u8FDE\u7EED\u5FFD\u7565\u51E0\u4E2A\u65B0\u7248\u672C\u30021 \u8868\u793A\u53EA\u5FFD\u7565\u5F53\u524D\u6700\u65B0\u7248\u672C\u3002", updateIgnorePrerelease: "\u624B\u52A8\u5F00\u542F\u540E\uFF0Calpha / beta / rc \u7B49\u9884\u53D1\u5E03\u7248\u672C\u4E0D\u4F1A\u88AB\u89C6\u4E3A\u53EF\u66F4\u65B0\u7248\u672C\u3002", chatlunaTool: "\u542F\u7528 ChatLuna \u63D2\u4EF6\u5E02\u573A\u67E5\u8BE2\u5DE5\u5177\u3002\u6B64\u529F\u80FD\u9700\u8981\u53E6\u884C\u5B89\u88C5\u5E76\u542F\u7528 ChatLuna\uFF1B\u6EE1\u8DB3\u6761\u4EF6\u540E\u4F1A\u6CE8\u518C\u53EA\u8BFB\u5DE5\u5177 koishi_plugin_market_search\u3002\u672A\u5B89\u88C5 ChatLuna \u4E0D\u5F71\u54CD\u63D2\u4EF6\u5E02\u573A\u7684\u5176\u4ED6\u529F\u80FD\u3002", frontendMode: { $description: "\u524D\u7AEF\u663E\u793A\u6A21\u5F0F\u3002\u6027\u80FD\u6A21\u5F0F\u4FDD\u6301\u4F4E\u52A8\u6548\uFF1B\u7CBE\u81F4\u6A21\u5F0F\u542F\u7528\u66F4\u7EC6\u817B\u7684\u52A8\u6548\u548C\u9AD8\u7EA7\u6837\u5F0F\u3002", $inner: ["\u6027\u80FD\u6A21\u5F0F", "\u7CBE\u81F4\u6A21\u5F0F"] }, depsLayout: { $description: "\u4F9D\u8D56\u7BA1\u7406\u9875\u5E03\u5C40\u3002\u7F51\u683C\u6A21\u5F0F\u591A\u5217\u5C55\u793A\uFF1B\u5217\u8868\u6A21\u5F0F\u5355\u5217\u5BBD\u5361\u7247\uFF0C\u4FE1\u606F\u66F4\u5BC6\u96C6\u3002", $inner: ["\u7F51\u683C", "\u5217\u8868"] }, marketSilentRules: { $description: "\u63D2\u4EF6\u5E02\u573A\u6C38\u4E45\u9759\u9ED8\u8FC7\u6EE4\u3002\u6DFB\u52A0\u540E\u547D\u4E2D\u7684\u63D2\u4EF6\u4F1A\u76F4\u63A5\u9690\u85CF\uFF0C\u4E0D\u4F1A\u663E\u793A\u5728\u641C\u7D22\u6846\u4E2D\u3002", type: { $description: "\u89C4\u5219\u7C7B\u578B", $inner: ["\u72B6\u6001\uFF1A\u9884\u89C8\u7248\u63D2\u4EF6", "\u72B6\u6001\uFF1A\u4E0D\u5B89\u5168\u63D2\u4EF6", "\u72B6\u6001\uFF1A\u63D2\u4EF6\u5305", "\u521B\u5EFA\u65F6\u95F4\uFF1A\u65E9\u4E8E\u6307\u5B9A\u65E5\u671F", "\u521B\u5EFA\u65F6\u95F4\uFF1A\u665A\u4E8E\u6307\u5B9A\u65E5\u671F", "\u66F4\u65B0\u65F6\u95F4\uFF1A\u65E9\u4E8E\u6307\u5B9A\u65E5\u671F", "\u66F4\u65B0\u65F6\u95F4\uFF1A\u665A\u4E8E\u6307\u5B9A\u65E5\u671F", "\u521B\u5EFA\u65F6\u95F4\uFF1A\u6700\u8FD1 N \u5929\u5185", "\u66F4\u65B0\u65F6\u95F4\uFF1A\u6700\u8FD1 N \u5929\u5185", "\u81EA\u5B9A\u4E49\u9AD8\u7EA7\u6761\u4EF6"] }, value: "\u89C4\u5219\u503C\u3002\u72B6\u6001\u7C7B\u7559\u7A7A\uFF1B\u65E5\u671F\u7C7B\u586B\u5199 YYYY-MM-DD\uFF1B\u6700\u8FD1 N \u5929\u586B\u5199\u6570\u5B57\uFF1B\u81EA\u5B9A\u4E49\u89C4\u5219\u586B\u5199\u641C\u7D22\u6761\u4EF6\u3002", note: "\u5907\u6CE8", enabled: "\u662F\u5426\u542F\u7528" } };
  }
});

// src/node/locales/schema.en-US.yml
var require_schema_en_US = __commonJS({
  "src/node/locales/schema.en-US.yml"(exports2, module2) {
    module2.exports = { registry: { $description: "Registry settings", endpoint: "Package download source. Follows the current project's npm config by default.", timeout: "Timeout for fetching package metadata.", autoRoute: "Automatically try fallback npm registries when version metadata cannot be fetched from the current registry.", retry: "Retry count after version metadata fails on each npm registry.", concurrency: "Maximum concurrency when loading dependency version metadata.", installLogRetentionHours: "How many hours dependency operation logs are retained. Defaults to 72 hours." }, search: { $description: "Search settings", endpoint: "URL used to search the plugin market. Uses the t4wefan mirror by default.", timeout: "Timeout for searching the plugin market.", proxyAgent: "Proxy used to search the plugin market.", autoRoute: "Automatically try fallback market sources when the current source fails.", logLevel: "Plugin market log level. silent disables logs; debug enables detailed logs." }, marketSilentFilters: "Legacy permanent silent filters.", idleProbe: "Automatically probes dependency versions and market data while Console is idle. It only runs when no browser console is connected, and page reloads do not trigger it.", idleProbeDelay: "How long Console must stay idle before the background probe starts.", idleProbeBootDelay: "Minimum delay after Koishi startup or reload before idle probing is allowed.", idleProbeInterval: "Minimum interval between idle background probes.", bulkMode: "Batch operation mode. Dependency install, update, and uninstall actions are staged until applying changes.", removeConfig: { $description: "Whether to remove existing plugin config when uninstalling a plugin. Ask every time when unset.", $inner: ["Ask every time", "Always remove plugin config", "Never remove plugin config"] }, updateIgnoredPackages: "Dependency package names that should not be checked for updates. One package per line, or separated by commas, semicolons, or spaces.", updateIgnoreDuration: "Default duration after ignoring one update. 0 means no time-based expiry.", updateIgnoreVersions: "How many consecutive newer versions should be ignored after ignoring one update. 1 means only the current latest version.", updateIgnorePrerelease: "When enabled, alpha / beta / rc and other prerelease versions are not treated as update targets.", chatlunaTool: "Enable the ChatLuna plugin market query tool. ChatLuna must be installed and enabled separately; when available, this registers the read-only koishi_plugin_market_search tool. Other market features work without ChatLuna.", frontendMode: { $description: "Frontend display mode. Performance mode keeps low-motion dense UI; polished mode enables richer visual effects.", $inner: ["Performance mode", "Polished mode"] }, depsLayout: { $description: "Dependencies page layout. Grid shows compact cards; list shows a denser single-column view.", $inner: ["Grid", "List"] }, marketSilentRules: { $description: "Permanent silent market filters. Matched plugins are hidden from the market page.", type: { $description: "Rule type", $inner: ["Status: plugin in development", "Status: insecure plugin", "Status: plugin bundle", "Created before a date", "Created after a date", "Updated before a date", "Updated after a date", "Created within the last N days", "Updated within the last N days", "Custom advanced condition"] }, value: "Rule value. Leave status rules empty; use YYYY-MM-DD for dates, a number for recent-day rules, or a search condition for custom rules.", note: "Note", enabled: "Enabled" } };
  }
});
...
__export(index_exports, {
  ...
  allRegistryAttemptsNotFound: () => allRegistryAttemptsNotFound,
  apply: () => apply,
  classifyDependencySource: () => classifyDependencySource,
  classifyRegistryNotFoundDependency: () => classifyRegistryNotFoundDependency,
  findDependenciesNeedingSourceCheck: () => findDependenciesNeedingSourceCheck,
  findUnboundLocalDependencies: () => findUnboundLocalDependencies,
  ...
  getRegistryAttemptReasons: () => getRegistryAttemptReasons,
  ...
  isLocalDependency: () => isLocalDependency,
  ...
  reuseConfirmedDependencySource: () => reuseConfirmedDependencySource,
  scanSensitiveConfig: () => scanSensitiveConfig,
  shouldIncludeDiscoveredLocalPlugin: () => shouldIncludeDiscoveredLocalPlugin,
  shouldPenalizeRegistryRoute: () => shouldPenalizeRegistryRoute,
  usage: () => usage,
...
var COLLAPSED_GROUPS_VERSION = 1;
var emptyStore = () => ({
  override: {},
  updateIgnored: {},
  bundleRecords: {},
...
async function readMarketDataStore(ctx) {
  const file = (0, import_path.resolve)(ctx.baseDir, "data", "market-next.json");
  try {
    return normalizeStore(JSON.parse(await import_fs.promises.readFile(file, "utf8")));
  } catch (error) {
...
var MarketDataStore = class extends import_console2.DataService {
  constructor(ctx) {
    super(ctx, "marketData", { immediate: true, authority: 4 });
    this.ctx = ctx;
    this.file = (0, import_path.resolve)(ctx.baseDir, "data", "market-next.json");
  ...
  async patch(patch) {
    await this.ready;
    let changed = false;
    for (const key of ["override", "updateIgnored", "bundleRecords", "collapsedGroups"]) {
  ...
  async migrateFromConfig(config) {
    ...
    if (migrateCollapsedGroups) {
      const collapsedGroups = normalizeDict(patch.collapsedGroups ?? this.data.collapsedGroups);
  ...
  async load() {
    try {
      const content = await import_fs.promises.readFile(this.file, "utf8");
      const value = JSON.parse(content);
      this.hasCollapsedGroupsState = Object.prototype.hasOwnProperty.call(value, "collapsedGroups");
      this.collapsedGroupsVersion = Number.isInteger(value?.collapsedGroupsVersion) ? Math.max(0, value.collapsedGroupsVersion) : 0;
  ...
  async write() {
    try {
      await import_fs.promises.mkdir((0, import_path.dirname)(this.file), { recursive: true });
      const tempFile = `${this.file}.${process.pid}.${Date.now()}.tmp`;
      await import_fs.promises.writeFile(tempFile, JSON.stringify({
        ...this.data,
        collapsedGroupsVersion: this.collapsedGroupsVersion
      }, null, 2));
      await import_fs.promises.rename(tempFile, this.file);
    } catch (error) {
...
function normalizeStore(value) {
  return {
    ...
    collapsedGroups: normalizeDict(value?.collapsedGroups)
  };
}
...
var import_registry5 = __toESM(require("@koishijs/registry"));
var import_path8 = require("path");
var import_fs8 = require("fs");
var import_semver9 = require("semver");
...
// src/shared/dependency-source.ts
var LOCAL_PROTOCOLS = ["file", "link", "portal", "workspace"];
function classifyDependencySource(request = "", options = {}) {
  const value = request.trim();
  const protocol = LOCAL_PROTOCOLS.find((protocol2) => value.toLowerCase().startsWith(`${protocol2}:`));
  if (protocol) {
    return {
      source: protocol,
      local: true,
...
function classifyRegistryNotFoundDependency(dependency, plugin) {
...
function reuseConfirmedDependencySource(previous, current, confirmationFresh) {
...
function findUnboundLocalDependencies(dependencies, changes) {
  return Object.entries(dependencies).filter(([name2, dependency]) => {
    if (!dependency || dependency.source !== "unbound") return false;
    return !Object.prototype.hasOwnProperty.call(changes, name2);
  }).map(([name2]) => name2).sort((a, b) => a.localeCompare(b));
}
function findDependenciesNeedingSourceCheck(dependencies, changes, completedNames) {
  ...
  return Object.entries(dependencies).filter(([name2, dependency]) => {
    ...
    if (completed.has(name2)) return false;
    return !Object.prototype.hasOwnProperty.call(changes, name2);
  }).map(([name2]) => name2).sort((a, b) => a.localeCompare(b));
}
function isLocalDependency(dependency) {
  ...
  return dependency.source === "workspace" || dependency.source === "file" || dependency.source === "link" || dependency.source === "portal" || dependency.source === "unbound";
}
function shouldIncludeDiscoveredLocalPlugin(options) {
  if (options.declared) return false;
  return !!(options.configured || options.running || options.workspace);
}
function allRegistryAttemptsNotFound(reasons) {
  return reasons.length > 0 && reasons.every((reason) => reason === "not-found");
}
function getRegistryAttemptReasons(error, fallback) {
  const reasons = error?.marketNextReasons;
  if (Array.isArray(reasons)) {
    const normalized = reasons.filter((reason) => typeof reason === "string" && !!reason);
    if (normalized.length) return normalized;
  }
  return fallback ? [fallback] : [];
}
function shouldPenalizeRegistryRoute(reason) {
...
var MarketProvider = class extends import_console3.DataService {
  _task;
  _timestamp = 0;
  _error;
  constructor(ctx) {
...
var FULL_RELOAD_DELAY = import_koishi2.Time.second;
var SELF_PACKAGE = "koishi-plugin-market-next";
var levelMap = {
  info: "info",
  warning: "debug",
  error: "warn"
};
function loadManifest(name2, baseDir) {
  const resolver = baseDir ? (0, import_module.createRequire)((0, import_path2.resolve)(baseDir, "package.json")) : require;
  const filename = resolver.resolve(name2 + "/package.json");
  const meta = JSON.parse((0, import_fs2.readFileSync)(filename, "utf8"));
  meta.dependencies ||= {};
  (0, import_koishi2.defineProperty)(meta, "$workspace", !filename.includes("node_modules"));
  return meta;
}
function resolvePackageManifest(name2, baseDir) {
  const resolver = (0, import_module.createRequire)((0, import_path2.resolve)(baseDir, "package.json"));
  return resolver.resolve(name2 + "/package.json");
}
function getVersions(versions) {
  return Object.fromEntries(versions.map((item) => [item.version, (0, import_koishi2.pick)(item, ["peerDependencies", "peerDependenciesMeta", "deprecated"])]).sort(([a], [b]) => (0, import_semver3.compare)(b, a)));
}
function sleep(ms) {
...
function formatLocalDeps(deps) {
  const entries = Object.entries(deps);
  if (!entries.length) return "(none)";
  return entries.map(([name2, dep]) => `${name2}{request=${dep.request || "-"},resolved=${dep.resolved ?? "-"},source=${dep.source ?? "-"},local=${!!dep.local}}`).join(", ");
}
...
// src/node/local-binding.ts
var logger2 = new import_koishi3.Logger("market");
var MAX_LOCAL_BINDING_PACK_SIZE = 64 * 1024 * 1024;
function parseNpmPackOutput(output) {
  ...
  const item = Array.isArray(parsed) ? parsed[0] : void 0;
...
function createLocalBindingRequest(filename) {
  return `file:.yarn/local/${validatePackFilename(filename)}`;
}
function createHashedLocalBindingFilename(filename, hash) {
...
async function prepareLocalBindingPackage(baseDir, name2, dependency, dependencies, timeout) {
  if (!import_registry2.default.isPlugin(name2) || !Object.prototype.hasOwnProperty.call(dependencies, name2)) {
  ...
  const currentRequest = dependencies[name2].replace(/^[~^]/, "");
  if (dependency.request !== currentRequest) {
    throw new Error("package.json \u5DF2\u53D1\u751F\u53D8\u5316\uFF0C\u8BF7\u5237\u65B0\u4F9D\u8D56\u540E\u91CD\u8BD5\u3002");
  }
  let manifestFile;
  try {
    manifestFile = resolvePackageManifest(name2, baseDir);
  } catch {
    throw new Error("\u65E0\u6CD5\u5B9A\u4F4D\u672C\u5730\u63D2\u4EF6\u76EE\u5F55\uFF1B\u8BF7\u786E\u8BA4\u63D2\u4EF6\u4ECD\u53EF\u88AB\u5F53\u524D Koishi \u5B9E\u4F8B\u52A0\u8F7D\u3002");
  }
  const sourceDir = (0, import_path3.dirname)(manifestFile);
  const manifest = JSON.parse(await import_fs3.promises.readFile(manifestFile, "utf8"));
  if (manifest.name !== name2 || manifest.version !== dependency.resolved) {
    throw new Error("\u672C\u5730\u63D2\u4EF6\u6E05\u5355\u4E0E\u5F53\u524D\u4F9D\u8D56\u72B6\u6001\u4E0D\u4E00\u81F4\uFF0C\u8BF7\u5237\u65B0\u4F9D\u8D56\u540E\u91CD\u8BD5\u3002");
  }
  const destination = (0, import_path3.resolve)(baseDir, ".yarn", "local");
  await import_fs3.promises.mkdir(destination, { recursive: true });
  const temporary = await import_fs3.promises.mkdtemp((0, import_path3.resolve)(destination, ".market-next-pack-"));
  try {
    const child = await (0, import_execa.default)("npm", [
      "pack",
      sourceDir,
      "--ignore-scripts",
      "--json",
      ...
      cwd: baseDir,
      timeout: Math.max(import_koishi3.Time.minute, timeout ?? 0)
    });
    const pack = parseNpmPackOutput(child.stdout);
    if (pack.name && pack.name !== name2 || pack.version && pack.version !== dependency.resolved) {
      throw new Error("\u672C\u5730\u63D2\u4EF6\u6253\u5305\u7ED3\u679C\u4E0E\u5F53\u524D\u4F9D\u8D56\u4E0D\u4E00\u81F4\u3002");
    }
    const packedFile = (0, import_path3.resolve)(temporary, pack.filename);
    if ((0, import_path3.dirname)(packedFile) !== temporary || (0, import_path3.relative)(temporary, packedFile).startsWith("..")) {
      throw new Error("\u672C\u5730\u63D2\u4EF6\u6253\u5305\u8DEF\u5F84\u65E0\u6548\u3002");
    }
    const stat = await import_fs3.promises.stat(packedFile);
    if (!stat.isFile() || stat.size <= 0 || stat.size > MAX_LOCAL_BINDING_PACK_SIZE || stat.size !== pack.size) {
      throw new Error("\u672C\u5730\u63D2\u4EF6\u6253\u5305\u6587\u4EF6\u65E0\u6548\u6216\u8FC7\u5927\u3002");
    }
    const content = await import_fs3.promises.readFile(packedFile);
    ...
    const target = (0, import_path3.resolve)(destination, filename);
    if ((0, import_path3.dirname)(target) !== destination || (0, import_path3.relative)(destination, target).startsWith("..")) {
      throw new Error("\u672C\u5730\u63D2\u4EF6\u76EE\u6807\u8DEF\u5F84\u65E0\u6548\u3002");
    }
    const validateExistingTarget = async () => {
      let targetStat;
      try {
        targetStat = await import_fs3.promises.stat(target);
      } catch (error) {
      ...
      const targetHash = (0, import_crypto.createHash)("sha256").update(await import_fs3.promises.readFile(target)).digest("hex");
      if (targetHash !== hash) {
    ...
    if (!await validateExistingTarget()) {
      try {
        await import_fs3.promises.rename(packedFile, target);
      } catch (error) {
        if (!await validateExistingTarget()) throw error;
      }
    }
    logger2.info(`local plugin source prepared: ${name2}@${dependency.resolved}, file=${filename}, size=${pack.size}`);
    return {
    ...
    await import_fs3.promises.rm(temporary, { recursive: true, force: true }).catch((error) => {
      logger2.debug(`failed to remove local binding temp directory ${temporary}: ${error instanceof Error ? error.message : error}`);
    });
  }
}
function validatePackFilename(value) {
  if (typeof value !== "string" || (0, import_path3.basename)(value) !== value || !/^[a-z0-9@._+-]+\.tgz$/i.test(value)) {
    throw new Error("invalid npm pack filename");
  }
  return value;
}

// src/node/local-upload.ts
...
var LOCAL_UPLOAD_CHUNK_SIZE = 512 * 1024;
var LOCAL_UPLOAD_TTL = 15 * 60 * 1e3;
var MAX_ARCHIVE_ENTRIES = 8192;
var MAX_ARCHIVE_EXPANDED_SIZE = 256 * 1024 * 1024;
var MAX_PACKAGE_MANIFEST_SIZE = 1024 * 1024;
var LocalPackageUploadStore = class {
  constructor(baseDir, warn) {
    this.warn = warn;
    this.root = (0, import_path4.resolve)(baseDir, ".yarn", "local");
    this.temporaryRoot = (0, import_path4.resolve)(this.root, ".market-next-upload");
  }
  warn;
  root;
  temporaryRoot;
  ...
  async start(request) {
    ...
    await import_fs4.promises.mkdir(this.temporaryRoot, { recursive: true });
    const uploadId = (0, import_crypto2.randomUUID)();
    const path = (0, import_path4.resolve)(this.temporaryRoot, `${uploadId}.part`);
    const handle = await (0, import_promises.open)(path, "wx");
    this.sessions.set(uploadId, {
      ...
      touchedAt: Date.now(),
      handle,
      hash: (0, import_crypto2.createHash)("sha256")
    });
  ...
  async commit(uploadId) {
    ...
    await this.closeHandle(session);
    await import_fs4.promises.mkdir(this.root, { recursive: true });
    const target = (0, import_path4.resolve)(this.root, session.validated.targetFilename);
    ...
    if (!existing) {
      try {
        await import_fs4.promises.rename(session.path, target);
      } catch (error) {
        const concurrent = await readFileHash(target);
        if (concurrent !== session.validated.hash) throw error;
        await import_fs4.promises.rm(session.path, { force: true });
      }
    } else {
      await import_fs4.promises.rm(session.path, { force: true });
    }
  ...
  async pruneExpired(now = Date.now()) {
    ...
    const entries = await import_fs4.promises.readdir(this.temporaryRoot, { withFileTypes: true }).catch((error) => {
      if (error.code === "ENOENT") return [];
      throw error;
    });
    await Promise.all(entries.map(async (entry) => {
      if (!entry.isFile() || !entry.name.endsWith(".part")) return;
      const path = (0, import_path4.resolve)(this.temporaryRoot, entry.name);
      if (activePaths.has(path)) return;
      const stat = await import_fs4.promises.stat(path);
      if (now - stat.mtimeMs <= LOCAL_UPLOAD_TTL) return;
      await import_fs4.promises.rm(path, { force: true });
    }));
  }
  async dispose() {
...
function getLocalPackageOperation(currentRequest, currentVersion, targetVersion) {
  if (!currentRequest) return "install";
  if (!currentVersion || !(0, import_semver4.valid)(currentVersion) || !(0, import_semver4.valid)(targetVersion)) return "replace";
  const result = (0, import_semver4.compare)(targetVersion, currentVersion);
  if (result > 0) return "upgrade";
  if (result < 0) return "downgrade";
  return "replace";
}
async function inspectPackageArchive(path) {
  let entryCount = 0;
  let expandedSize = 0;
  let manifestFound = false;
  const chunks = [];
  try {
    await (0, import_tar.list)({
      file: path,
      strict: true,
  ...
  if (typeof manifest.name !== "string" || !import_registry3.default.isPlugin(manifest.name)) {
    throw new Error("\u5F52\u6863\u4E2D\u7684\u5305\u540D\u4E0D\u662F\u6709\u6548\u7684 Koishi \u63D2\u4EF6\u540D\u79F0\u3002");
  }
  if (typeof manifest.version !== "string" || !(0, import_semver4.valid)(manifest.version)) {
    throw new Error("\u5F52\u6863\u4E2D\u7684\u63D2\u4EF6\u7248\u672C\u4E0D\u662F\u6709\u6548\u7684 SemVer\u3002");
  }
  return manifest;
}
function validateArchiveEntry(value, type) {
...
function validateUploadFilename(value) {
  if (typeof value !== "string" || (0, import_path4.basename)(value) !== value || !value.toLowerCase().endsWith(".tgz")) {
    throw new Error("\u8BF7\u9009\u62E9 npm pack \u751F\u6210\u7684 .tgz \u6587\u4EF6\u3002");
  }
  return value;
}
function decodeBase64Chunk(value) {
  if (typeof value !== "string" || value.length > Math.ceil(LOCAL_UPLOAD_CHUNK_SIZE / 3) * 4 + 4 || value.length % 4 || !/^[A-Za-z0-9+/]*={0,2}$/.test(value)) {
...
function createCanonicalLocalPackageFilename(name2, version, hash) {
  const slug = name2.replace(/^@/, "").replace(/[\\/]+/g, "-").replace(/[^a-z0-9@._+-]+/gi, "-").slice(0, 120);
...
async function readFileHash(path) {
  try {
    ...
    return (0, import_crypto2.createHash)("sha256").update(await import_fs4.promises.readFile(path)).digest("hex");
  } catch (error) {
...
function assertInside(root, target) {
  if ((0, import_path4.dirname)(target) !== root || (0, import_path4.relative)(root, target).startsWith("..")) {
...
function normalizeEnvironmentDependencies(dependencies) {
  const result = {};
  for (const name2 of Object.keys(dependencies).sort((a, b) => a.localeCompare(b))) {
    const dependency = dependencies[name2];
    ...
    result[name2] = {
      ...
      resolved: dependency.resolved || void 0,
      workspace: dependency.workspace || void 0,
      source: dependency.source || source.source,
      local: (dependency.local ?? source.local) || void 0,
      bound: dependency.bound,
      invalid: dependency.invalid || void 0
    };
  }
  return result;
}
function canonicalDependencies(dependencies) {
  ...
  return JSON.stringify(Object.entries(normalized).map(([name2, dependency]) => [
    name2,
...
function getEnvironmentSnapshotId(dependencies) {
  return `env-${(0, import_crypto3.createHash)("sha256").update(canonicalDependencies(dependencies)).digest("hex").slice(0, 20)}`;
}
function createEnvironmentSnapshot(dependencies, source, operationId, now = Date.now()) {
  const normalized = normalizeEnvironmentDependencies(dependencies);
  return {
...
function sameDependency(left, right) {
  ...
  if (left.local || right.local) {
    return left.request === right.request && left.source === right.source && !!left.local === !!right.local;
  }
  return (left.resolved || left.request) === (right.resolved || right.request);
}
function displayVersion(dependency) {
  return dependency?.resolved || dependency?.request;
}
function getEnvironmentDiff(current, target) {
  const names = /* @__PURE__ */ new Set([
    ...Object.keys(current.dependencies),
    ...Object.keys(target.dependencies)
  ]);
  return [...names].sort((a, b) => a.localeCompare(b)).map((name2) => {
    const currentDependency = current.dependencies[name2];
    const targetDependency = target.dependencies[name2];
    const base = {
      name: name2,
    ...
    if (currentVersion && targetVersion && (0, import_semver5.valid)(currentVersion) && (0, import_semver5.valid)(targetVersion)) {
      const direction = (0, import_semver5.compare)(targetVersion, currentVersion);
...
function getEnvironmentInstallChanges(diff, target) {
  const changes = {};
...
function summarizeEnvironmentSnapshot(snapshot, currentId) {
  return {
    id: snapshot.id,
...
var EnvironmentSnapshotStore = class {
  ...
  value = { version: 1, snapshots: [] };
  async load() {
    if (!this.loaded) {
      this.loaded = (async () => {
        try {
          const parsed = JSON.parse(await import_fs5.promises.readFile(this.filename, "utf8"));
  ...
  async persist() {
    await import_fs5.promises.mkdir((0, import_path5.dirname)(this.filename), { recursive: true });
    const temporary = `${this.filename}.${process.pid}.${Date.now()}.tmp`;
    await import_fs5.promises.writeFile(temporary, JSON.stringify(this.value, null, 2) + "\n");
    try {
      await import_fs5.promises.rename(temporary, this.filename);
    } catch (error) {
      if (!["EEXIST", "EPERM"].includes(error?.code)) throw error;
      await import_fs5.promises.rm(this.filename, { force: true });
      await import_fs5.promises.rename(temporary, this.filename);
    }
  }
...
// src/node/registry-metadata.ts
var import_koishi5 = require("koishi");
var import_registry4 = __toESM(require("@koishijs/registry"));
var import_semver6 = require("semver");

// src/node/registry-router.ts
var import_koishi4 = require("koishi");
var import_fs6 = require("fs");
var import_path6 = require("path");
var import_get_registry = __toESM(require("get-registry"));

// src/node/route-health.ts
var DEFAULT_RECENT_SUCCESS_WINDOW = 10 * 60 * 1e3;
function scoreRouteHealth(stats, options) {
  ...
  if (stats.averageElapsed != null) {
    ...
    else if (stats.averageElapsed <= 4e3) score -= 1;
    else score -= 2;
  }
...
// src/node/registry-router.ts
var logger3 = new import_koishi4.Logger("market");
...
var REGISTRY_ROUTE_STAGGER = 120;
var REGISTRY_FAST_ROUTE_THRESHOLD = import_koishi4.Time.second * 0.8;
var REGISTRY_STATS_TTL = import_koishi4.Time.day * 30;
var RegistryRouter = class {
  constructor(ctx, config) {
    this.ctx = ctx;
    this.config = config;
    this.statsFile = (0, import_path6.resolve)(ctx.baseDir, "cache", "market-next-registry-stats.json");
  }
  ctx;
  config;
  endpointValue = "";
  ...
  async ensureEndpoint(name2, serial = this.currentSerial) {
  ...
  getRouteProbeResult(name2, serial) {
    const probe = this.routeProbeResult;
    if (probe?.serial === serial && probe.name === name2 && probe.endpoint === this.metadataEndpoint) return probe;
  }
  selectEndpoint(endpoint) {
    this.metadataEndpoint = endpoint;
  }
  getInstallFallbackCandidate(failedEndpoint) {
    ...
    const now = Date.now();
    const candidates = this.getRegistryEndpointCandidates().filter((endpoint) => normalize(endpoint) !== failed).filter((endpoint) => normalize(endpoint) !== normalize(this.config.endpoint)).map((endpoint, index) => ({
      endpoint,
      index,
  ...
  async fetchRegistryByRoute(name2, endpoints, serial, onAttempt) {
    let attempts = 0;
    let lastEndpoint = endpoints[0];
    const result = await this.raceEndpoints(name2, endpoints, serial, (endpoint) => {
  ...
  async loadRouteStats() {
    try {
      const content = await import_fs6.promises.readFile(this.statsFile, "utf8");
      ...
      for (const [endpoint, stats] of Object.entries(store.stats)) {
        ...
        const hasRecentSuccess = Number(stats.lastSuccess) && Date.now() - Number(stats.lastSuccess) < import_koishi4.Time.day;
      ...
      logger3.debug(`npm registry route stats restored from disk: ${Object.keys(store.stats).join(", ")}`);
    } catch (error) {
      if (error?.code !== "ENOENT") logger3.debug(`failed to load registry route stats: ${error instanceof Error ? error.message : error}`);
    }
  }
  scheduleStatsWrite() {
    clearTimeout(this.statsWriteTimer);
    this.statsWriteTimer = setTimeout(async () => {
      this.statsWriteTimer = void 0;
      ...
      try {
        await import_fs6.promises.mkdir((0, import_path6.resolve)(this.statsFile, ".."), { recursive: true });
        await import_fs6.promises.writeFile(this.statsFile, JSON.stringify({ version: 1, stats, savedAt: Date.now() }));
      } catch (error) {
        logger3.debug(`failed to write registry route stats: ${error instanceof Error ? error.message : error}`);
      }
    }, 2e3);
  }
  async resetEndpoint() {
    ...
    if (previous && previous !== endpoint) {
      this.routeStats = {};
      logger3.info(`npm registry endpoint changed: previous=${previous}, current=${endpoint}, routeStats=reset`);
    }
  }
  getRegistryEndpoints() {
    const preferred = this.getPreferredMetadataEndpoint();
    return [preferred, ...this.getRouteProbeEndpoints()].filter((endpoint, index, array) => !!endpoint && array.indexOf(endpoint) === index);
  }
  getPreferredMetadataEndpoint() {
    ...
    if (stats.failures >= 2 && selectedScore + 1 < primaryScore) {
      logger3.debug(`demote npm metadata endpoint: selected=${endpoint}, selectedScore=${selectedScore.toFixed(1)}, primary=${this.endpointValue}, primaryScore=${primaryScore.toFixed(1)}, failures=${stats.failures}, lastFailure=${stats.lastFailureReason ?? "-"}`);
      return this.endpointValue;
    }
    return endpoint;
  }
  getRegistryEndpointCandidates() {
    return [this.endpointValue, ...this.config.autoRoute === false ? [] : REGISTRY_FALLBACK_ENDPOINTS].filter((endpoint, index, array) => !!endpoint && array.indexOf(endpoint) === index);
  }
  ...
  raceEndpoints(name2, endpoints, serial, onAttempt) {
    ...
    if (endpoints.length === 1 || this.config.autoRoute === false) {
      ...
      return this.fetchRegistryEndpoint(name2, endpoints[0], serial, controller.signal).then((result) => {
    ...
    return new Promise((resolve11, reject) => {
      ...
      const startEndpoint = (endpoint, index, waitIndex = 0) => {
        ...
        this.waitRouteTurn(waitIndex, signal).then(() => {
          ...
          onAttempt?.(endpoint);
          return this.fetchRegistryEndpoint(name2, endpoint, serial, signal);
      ...
      const startFallback = (reason) => {
        ...
        logger3.info(`npm registry fallback race started: probe=${name2}, reason=${reason}, count=${endpoints.length - 1}`);
  ...
  async probeMetadataEndpoint(name2, endpoints, serial) {
    ...
    logger3.info(`npm registry route probe started: probe=${name2}, primary=${endpoints[0]}, fallbackCount=${Math.max(0, endpoints.length - 1)}, slowThreshold=${this.getFallbackDelay(endpoints[0])}ms`);
    try {
      const result = await this.raceEndpoints(name2, endpoints, serial);
      if (this.isStale(serial)) return;
      this.applyRouteProbeResult(name2, result, serial, start);
    } catch {
      if (this.isStale(serial)) return;
      logger3.warn(`npm registry route probe failed: probe=${name2}, candidates=${endpoints.length}, elapsed=${Date.now() - start}ms`);
    }
  }
  async fetchRegistryEndpoint(name2, endpoint, serial, signal) {
    const attemptStart = Date.now();
    try {
      logger3.debug(`fetch npm registry endpoint: package=${name2}, endpoint=${endpoint}`);
      const registry = await this.createHttp(endpoint).get(`/${name2}`, { signal });
      ...
      logger3.debug(`fetch npm registry endpoint succeeded: package=${name2}, endpoint=${endpoint}, elapsed=${elapsed}ms, versions=${Object.keys(registry.versions).length}`);
      return { endpoint, registry, elapsed };
    } catch (error) {
      const detail = this.formatError(error);
      logger3.debug(`fetch npm registry endpoint failed: package=${name2}, endpoint=${endpoint}, elapsed=${Date.now() - attemptStart}ms, reason=${detail.reason}, error=${detail.error}`);
      throw error;
    }
  }
  applyRouteProbeResult(name2, result, serial, start) {
    ...
    if (result.endpoint === this.endpointValue) {
      logger3.info(`npm registry primary selected: probe=${name2}, endpoint=${result.endpoint}, elapsed=${result.elapsed}ms, total=${Date.now() - start}ms`);
    } else {
      logger3.info(`npm registry fallback selected: probe=${name2}, endpoint=${result.endpoint}, previous=${previous}, reason=${result.fallbackReason ?? "unknown"}, elapsed=${result.elapsed}ms, total=${Date.now() - start}ms`);
    }
    logger3.debug(`npm registry route scores after probe: ${formatRouteScores(this.getRouteScores())}`);
  }
  waitRouteTurn(index, signal) {
    if (!index) return Promise.resolve();
    return new Promise((resolve11, reject) => {
      if (signal?.aborted) return reject(signal.reason);
      const timer = setTimeout(resolve11, index * REGISTRY_ROUTE_STAGGER);
  ...
  getRouteScore(endpoint, now = Date.now()) {
    const stats = this.routeStats[endpoint];
  ...
  recordRouteSuccess(result) {
    ...
    stats.averageElapsed = stats.averageElapsed == null ? result.elapsed : Math.round(stats.averageElapsed * 0.7 + result.elapsed * 0.3);
  ...
  getFallbackDelay(endpoint) {
    const stats = this.routeStats[endpoint];
    if (!stats) return REGISTRY_FAST_ROUTE_THRESHOLD;
    const recentSuccess = stats.lastSuccess && Date.now() - stats.lastSuccess <= import_koishi4.Time.minute * 10;
    if (!recentSuccess && stats.failures >= 3) return 200;
    if (!recentSuccess && stats.failures >= 2) return 400;
    if (stats.averageElapsed != null) {
      if (stats.averageElapsed > 4e3) return 400;
  ...
  getRouteScores() {
    ...
    return this.getRegistryEndpointCandidates().map((endpoint) => ({
      endpoint,
      score: this.getRouteScore(endpoint, now),
      fallbackDelay: endpoint === this.endpointValue ? this.getFallbackDelay(endpoint) : void 0,
      ...this.routeStats[endpoint]
    }));
  }
...
function getFailurePenalty(reason) {
  switch (reason) {
    case "not-found":
      return 0.4;
    case "invalid":
...
function formatRouteScores(routes) {
  ...
  return routes.map((route) => `${route.endpoint} score=${route.score.toFixed(1)} ok=${route.successes ?? 0} fail=${route.failures ?? 0} avg=${route.averageElapsed ?? "-"} delay=${route.fallbackDelay ?? "-"} last=${route.lastFailureReason ?? "-"}`).join(" | ");
}
function formatEndpointHost(endpoint) {
  try {
...
// src/node/registry-metadata.ts
var logger4 = new import_koishi5.Logger("market");
var NOT_FOUND_CACHE_TTL = import_koishi5.Time.minute * 5;
var RegistryMetadata = class {
  constructor(ctx, config) {
    this.ctx = ctx;
    this.config = config;
  ...
  hasRecentNotFound(name2) {
    const timestamp = this.notFoundCache[name2];
    return !!timestamp && Date.now() - timestamp < NOT_FOUND_CACHE_TTL;
  }
  async ensureEndpoint(name2, serial = this.serial) {
    await this.router.ensureEndpoint(name2, serial);
  }
  async getRegistry(name2, serial = this.serial) {
    ...
    await this.ensureEndpoint(name2, serial);
    if (this.isStale(serial)) return;
    const probe = this.router.getRouteProbeResult(name2, serial);
    if (probe) {
      attempts = 1;
      this.setRegistryStatus(name2, {
        loading: false,
      ...
      logger4.debug(`reuse npm registry route probe payload for ${name2}: endpoint=${probe.endpoint}, probeElapsed=${probe.elapsed}ms`);
      return probe.registry;
    }
    for (let retry = 0; retry <= maxRetry; retry++) {
      const endpoints = this.router.getRegistryEndpoints();
      logger4.debug(`registry metadata candidates for ${name2}: endpoints=${endpoints.join(", ")}, retry=${retry + 1}/${maxRetry + 1}, concurrency=${this.config.concurrency ?? 4}`);
      try {
        const result = await this.router.fetchRegistryByRoute(name2, endpoints, serial, (endpoint) => {
          attempts++;
          lastEndpoint = endpoint;
        ...
        if (result.endpoint !== this.selectedEndpoint) {
          logger4.debug(`routed npm registry endpoint for ${name2}: ${result.endpoint}`);
          logger4.info(`npm registry route selected for ${name2}: endpoint=${result.endpoint}, previous=${this.selectedEndpoint}, reason=${result.fallbackReason ?? "same-priority"}, elapsed=${result.elapsed}ms`);
        ...
        logger4.debug(`loaded registry metadata for ${name2} from ${result.endpoint} in ${result.elapsed}ms, attempts=${attempts}, versions=${Object.keys(result.registry.versions).length}`);
        return result.registry;
      } catch (error) {
        lastError = error;
        const detail2 = this.formatError(error);
        failureReasons.push(...getRegistryAttemptReasons(error, detail2.reason));
        logger4.debug(`failed routed registry metadata for ${name2}, attempt=${retry + 1}/${maxRetry + 1}, endpoint=${lastEndpoint}, attempts=${attempts}: ${detail2.error}`);
        if (retry < maxRetry) await sleep(300 * (retry + 1));
      }
    }
    const detail = this.formatError(lastError);
    const finalDetail = allRegistryAttemptsNotFound(failureReasons) ? detail : failureReasons.some((reason) => reason !== "not-found") ? { reason: failureReasons.find((reason) => reason !== "not-found"), error: detail.error } : detail;
    this.setRegistryStatus(name2, {
      loading: false,
    ...
    logger4.warn(`failed to fetch registry metadata for ${name2}: ${detail.error}`);
  ...
  getPackage(name2) {
    const notFoundAt = this.notFoundCache[name2];
    if (notFoundAt && Date.now() - notFoundAt < NOT_FOUND_CACHE_TTL) {
      return Promise.resolve(void 0);
    }
    if (notFoundAt) delete this.notFoundCache[name2];
    if (!this.pkgTasks[name2]) {
      const task = this.fetchPackage(name2, this.serial);
      ...
      task.then((versions) => {
        ...
        const reason = this.formatError(error).reason;
        if (reason === "not-found") this.notFoundCache[name2] = Date.now();
      });
    }
  ...
  async fetchPackage(name2, serial = this.serial) {
    try {
      ...
      this.fullCache[name2] = this.tempCache[name2] = getVersions(Object.values(registry.versions).filter((remote) => {
        if (name2 === "koishi") return (0, import_semver6.satisfies)(remote.version, "4");
        return !import_registry4.default.isPlugin(name2) || import_registry4.default.isCompatible("4", remote);
      }));
      this.flushData();
      return this.fullCache[name2];
    } catch (error) {
      logger4.warn(error instanceof Error ? error.message : error);
      throw error;
    }
  }
};

// src/node/install-history.ts
var import_koishi6 = require("koishi");
var import_path7 = require("path");
var import_fs7 = require("fs");
var logger5 = new import_koishi6.Logger("market");
var DEFAULT_INSTALL_LOG_RETENTION = import_koishi6.Time.day * 3;
var INSTALL_LOG_DIR = "market-next-install-logs";
var INSTALL_LOG_DETAIL_LIMIT = 512 * 1024;
var INSTALL_LOG_HEAD_LIMIT = 8 * 1024;
var INSTALL_LOG_TAIL_LIMIT = 32 * 1024;
var InstallHistoryStore = class {
  constructor(ctx, config, getResolvedVersion) {
    this.ctx = ctx;
    this.config = config;
    this.getResolvedVersion = getResolvedVersion;
  }
  ctx;
  config;
  getResolvedVersion;
  ...
  async cleanup() {
    ...
    this.cleanupTask = (async () => {
      ...
      try {
        ...
        const now = Date.now();
        await Promise.all(entries.filter((entry) => entry.isFile() && (entry.name.endsWith(".log") || entry.name.endsWith(".log.json"))).map(async (entry) => {
          const path = (0, import_path7.resolve)(dir, entry.name);
          if (path === this.logFile || path === this.metadataFile) return;
          try {
            const stat = await import_fs7.promises.stat(path);
            if (now - stat.mtimeMs <= this.getRetention()) return;
            await import_fs7.promises.rm(path, { force: true });
          } catch (error) {
            logger5.debug(`failed to cleanup install log ${path}: ${error instanceof Error ? error.message : error}`);
          }
        }));
      } catch (error) {
        if (error?.code !== "ENOENT") {
          logger5.debug(`failed to cleanup install logs: ${error instanceof Error ? error.message : error}`);
        }
      }
    })().finally(() => {
      this.cleanupTask = void 0;
    });
    return this.cleanupTask;
  }
  async start(deps, forced, options = {}, changes = []) {
    await this.cleanup();
    const dir = this.getDirectory();
    await import_fs7.promises.mkdir(dir, { recursive: true });
    const now = Date.now();
    const suffix = sanitizeLogSegment(formatDeps(deps) || "noop");
    const file = (0, import_path7.resolve)(dir, `${formatLogTimestamp(now)}-${suffix}.log`);
    const id = (0, import_path7.basename)(file);
    await import_fs7.promises.writeFile(file, [
    ...
    this.metadata = {
      ...
      deps: formatDeps(deps) || "(none)",
      forced: !!forced,
      installEndpoint: options.installEndpoint || void 0,
      changes
    };
    this.writeTask = Promise.resolve();
    await this.writeMetadata().catch((error) => {
      logger5.debug(`failed to write install log metadata ${this.metadataFile}: ${error instanceof Error ? error.message : error}`);
    });
    logger5.info(`dependency install log started: ${file}`);
  }
  emit(type, line) {
  ...
  async finish(result) {
    ...
    if (this.metadata) {
      ...
      await this.writeMetadata().catch((error) => {
        logger5.debug(`failed to finish install log metadata ${this.metadataFile}: ${error instanceof Error ? error.message : error}`);
      });
    }
    logger5.info(`dependency install log saved: ${this.logFile}`);
    this.resetCurrent();
  }
  async getHistory(limit = 20) {
    await this.cleanup();
    const count = clamp2(Math.floor(Number(limit) || 20), 1, 50);
    const dir = this.getDirectory();
    let files = [];
    try {
      const entries = await import_fs7.promises.readdir(dir, { withFileTypes: true });
      files = (await Promise.all(entries.filter((entry) => entry.isFile() && entry.name.endsWith(".log")).map(async (entry) => ({
        id: entry.name,
        mtime: (await import_fs7.promises.stat((0, import_path7.resolve)(dir, entry.name))).mtimeMs
  ...
  getDirectory() {
    return (0, import_path7.resolve)(this.ctx.baseDir, "data", INSTALL_LOG_DIR);
  }
  getRetention() {
    const hours = Number(this.config.installLogRetentionHours);
    if (Number.isFinite(hours) && hours > 0) return Math.max(1, hours) * import_koishi6.Time.hour;
    const legacyRetention = Number(this.config.installLogRetention);
    return Number.isFinite(legacyRetention) && legacyRetention > 0 ? Math.max(import_koishi6.Time.hour, legacyRetention) : DEFAULT_INSTALL_LOG_RETENTION;
  }
  async writeMetadata() {
    if (!this.metadataFile || !this.metadata) return;
    await import_fs7.promises.writeFile(this.metadataFile, JSON.stringify(this.metadata, null, 2) + "\n");
  }
  write(type, line) {
    const file = this.logFile;
    if (!file) return;
    const text = `[${(/* @__PURE__ */ new Date()).toISOString()}] [${type}] ${line}
`;
    this.writeTask = this.writeTask.then(() => import_fs7.promises.appendFile(file, text)).catch((error) => {
      logger5.debug(`failed to write install log ${file}: ${error instanceof Error ? error.message : error}`);
    });
  }
  getPath(id) {
    if (!id || (0, import_path7.basename)(id) !== id || !id.endsWith(".log")) return;
    return (0, import_path7.resolve)(this.getDirectory(), id);
  }
  async readMetadata(id) {
    const file = this.getPath(id);
    if (!file) return;
    try {
      const metadata = JSON.parse(await import_fs7.promises.readFile(file + ".json", "utf8"));
      if (metadata?.version !== 1 || metadata.id !== id || !Array.isArray(metadata.changes)) return;
      return metadata;
    } catch (error) {
      if (error?.code !== "ENOENT" && !(error instanceof SyntaxError)) {
        logger5.debug(`failed to read install log metadata ${id}: ${error instanceof Error ? error.message : error}`);
      }
    }
  }
  async readLog(file, limit, headLimit, tailLimit) {
    const stat = await import_fs7.promises.stat(file);
    if (stat.size <= limit) {
      return {
        content: await import_fs7.promises.readFile(file, "utf8"),
        truncated: false,
        size: stat.size
      };
    }
    const handle = await import_fs7.promises.open(file, "r");
    try {
...
${tail.toString("utf8")}`,
  ...
  parseLegacy(id, content, size) {
    ...
    const active = (0, import_path7.basename)(this.logFile || "") === id;
    const status = active ? "running" : /dependency operation finished with code 0\s*$/m.test(content) ? "success" : /dependency operation (?:failed|finished with code|ended without)|package manager (?:terminated|failed to start)/m.test(content) ? "error" : "unknown";
    const timestamps = [...content.matchAll(/^\[([^\]]+)\]/gm)];
    const finishedAt = status === "running" ? void 0 : Date.parse(timestamps.at(-1)?.[1] || "") || void 0;
    return {
      id,
      startedAt,
      finishedAt,
      duration: startedAt && finishedAt ? Math.max(0, finishedAt - startedAt) : void 0,
      status,
      deps,
      forced,
      installEndpoint: endpointText && endpointText !== "(default)" ? endpointText : void 0,
      size,
      changes: []
    };
  }
  createEntry(metadata, size) {
    const status = metadata.status === "running" && (0, import_path7.basename)(this.logFile || "") !== metadata.id ? "unknown" : metadata.status;
    return {
      id: metadata.id,
      startedAt: metadata.startedAt,
      finishedAt: metadata.finishedAt,
      duration: metadata.finishedAt ? Math.max(0, metadata.finishedAt - metadata.startedAt) : void 0,
      status,
      deps: metadata.deps,
  ...
  async getEntry(id) {
    ...
    let stat;
    try {
      stat = await import_fs7.promises.stat(file);
    } catch (error) {
...
function createInstallHistoryChanges(before, after, localDeps) {
  return Object.keys(after).map((name2) => ({
    name: name2,
    beforeRequest: Object.prototype.hasOwnProperty.call(before, name2) ? before[name2] : null,
    beforeResolved: localDeps[name2]?.resolved ?? null,
    afterRequest: after[name2] || null,
    afterResolved: null
  }));
}
...
function sanitizeInstallLogText(value) {
  return value.replace(/\u001B\][^\u0007]*(?:\u0007|\u001B\\)/g, "").replace(/[\u001B\u009B][[\]()#;?]*(?:(?:(?:[a-zA-Z\d]*(?:;[-a-zA-Z\d/#&.:=?%@~_]+)*)?\u0007)|(?:(?:\d{1,4}(?:[;:]\d{0,4})*)?[\dA-PR-TZcf-nq-uy=><~]))/g, "").replace(/\r(?!\n)/g, "");
}
function clamp2(value, min, max) {
  return Math.min(max, Math.max(min, value));
}

// src/node/installer-transaction.ts
var import_semver7 = require("semver");
function requiresPackageManager(input) {
  const {
    changes,
    currentDependencies,
    currentLocalDeps,
  ...
  for (const name2 in changes) {
    const nextRequest = changes[name2];
    const currentRequest = currentDependencies[name2];
    const currentSource = classifyDependencySource(currentRequest ?? "", {
      workspace: currentLocalDeps[name2]?.workspace,
      installed: !!currentLocalDeps[name2]?.resolved
    });
    const nextSource = classifyDependencySource(nextRequest ?? "", {
      workspace: nextLocalDeps[name2]?.workspace,
      installed: !!nextLocalDeps[name2]?.resolved
    });
    if (!nextRequest) return true;
    if (currentRequest !== nextRequest && (currentSource.local || nextSource.local)) return true;
    const { resolved, local } = nextLocalDeps[name2] || {};
    if (local || resolved && (0, import_semver7.satisfies)(resolved, nextRequest, { includePrerelease: true })) continue;
    return true;
  }
  return false;
}
function hasDependencyRuntimeChange(input) {
  const {
    name: name2,
    changes,
  ...
  const next = nextLocalDeps[name2];
  if (!next) return false;
  if (next.resolved !== previousLocalDeps[name2]?.resolved) return true;
  if (previousDependencies[name2] === changes[name2]) return false;
  return classifyDependencySource(changes[name2] ?? "", {
    workspace: next.workspace,
    installed: !!next.resolved
  }).local;
}

// src/node/package-manager.ts
var import_koishi7 = require("koishi");
var import_execa2 = __toESM(require("execa"));
var import_semver8 = require("semver");
var logger6 = new import_koishi7.Logger("market");
var PackageManagerOutput = class {
  constructor(useJson, emit) {
  ...
  emitStdoutLine(line) {
    ...
    try {
      ...
      logger6[levelMap[type] ?? "info"](data);
...
var PackageManagerRunner = class {
  constructor(cwd, agent, emit, spawnProcess = import_execa2.default) {
    this.cwd = cwd;
    this.agent = agent;
    this.emit = emit;
  ...
  async exec(args) {
    ...
    const version = this.agent?.version ? (0, import_semver8.coerce)(this.agent.version) : null;
    const useJson = name2 === "yarn" && !!version && (0, import_semver8.gte)(version, "2.0.0");
    const finalArgs = [...args];
    if (name2 !== "yarn") finalArgs.unshift("install");
    const start = Date.now();
    logger6.info(`run package manager: agent=${name2}${this.agent?.version ? "@" + this.agent.version : ""}, args=${finalArgs.join(" ") || "(none)"}, cwd=${this.cwd}, json=${useJson}`);
    return new Promise((resolve11) => {
      if (useJson) finalArgs.push("--json");
      const child = this.spawnProcess(name2, finalArgs, { cwd: this.cwd });
      this.emit("stdout", `package manager started: agent=${name2}${this.agent?.version ? "@" + this.agent.version : ""}`);
      ...
      child.on("exit", (code, signal) => {
        logger6.info(`package manager exited: code=${code}, signal=${signal ?? "-"}, elapsed=${Date.now() - start}ms`);
        if (code == null) {
          const message = signal ? `package manager terminated by signal ${signal}` : "package manager exited without an exit code";
      ...
      child.on("error", (error) => {
        logger6.warn(`package manager failed to start: ${error instanceof Error ? error.message : String(error)}`);
...
function appendLines(buffer, data, emit) {
...
// src/node/installer.ts
var logger7 = new import_koishi8.Logger("market");
var Installer = class extends import_koishi8.Service {
  constructor(ctx, config = {}) {
    super(ctx, "installer");
    this.ctx = ctx;
    this.config = config;
    ...
    this.installHistory = new InstallHistoryStore(ctx, config, (name2) => this.depCache[name2]?.resolved);
    this.environmentSnapshots = new EnvironmentSnapshotStore(
      (0, import_path8.resolve)(ctx.baseDir, "data", "market-next-environment-snapshots.json"),
      (message) => logger7.warn(message)
    );
    this.localPackageUploads = new LocalPackageUploadStore(ctx.baseDir, (message) => logger7.warn(message));
    this.packageManager = new PackageManagerRunner(this.cwd, (0, import_which_pm_runs.default)(), (type, line) => {
      this.emitInstallLog(type, line);
    });
    ctx.setInterval(() => {
      void this.localPackageUploads.pruneExpired();
    }, import_koishi8.Time.minute * 5);
    ctx.effect(() => () => {
  ...
  depCache = {};
  depTask;
  depMetadataFresh = false;
  installTask = Promise.resolve();
  installActive = false;
  metadata;
  installHistory;
  ...
  async start() {
    ...
    logger7.debug(`registry endpoint initialized: ${this.endpoint}, timeout=${this.config.timeout ?? "default"}, autoRoute=${this.config.autoRoute !== false}`);
    logger7.info(`npm registry endpoint initialized: ${this.endpoint}, timeout=${this.config.timeout ?? "default"}, autoRoute=${this.config.autoRoute !== false}`);
    await this.recordCurrentEnvironmentSnapshot("startup").catch((error) => {
      logger7.warn(`failed to record startup environment snapshot: ${error instanceof Error ? error.message : error}`);
    });
    const dependencies = this.getDeps({ background: false });
    logger7.info(`dependency startup metadata probe scheduled: deps=${Object.keys(dependencies).length}`);
  ...
  getRegistry(name2, serial = this.metadata.serial) {
    return this.metadata.getRegistry(name2, serial);
  }
  setPackage(name2, versions) {
    this.metadata.setPackage(name2, versions);
  }
  getPackage(name2) {
    return this.metadata.getPackage(name2);
  }
  ...
  markRegistryNotFoundDependency(name2, dependency = this.depCache[name2]) {
    const source = classifyRegistryNotFoundDependency(dependency, import_registry5.default.isPlugin(name2));
    if (!source || !dependency) return false;
    Object.assign(dependency, source);
    dependency.invalid = false;
    delete dependency.latest;
    logger7.info(`dependency classified as unbound local plugin: ${name2}@${dependency.resolved}`);
    return true;
  }
  getLocalDepsSnapshot() {
    const start = Date.now();
    const result = (0, import_koishi8.valueMap)(this.manifest.dependencies, (request) => {
      return { request: request.replace(/^[~^]/, "") };
    });
    const names = Object.keys(result);
    for (const name2 of names) {
      try {
        const meta = loadManifest(name2, this.cwd);
        result[name2].resolved = meta.version;
        result[name2].workspace = meta.$workspace;
        logger7.debug(`local dependency resolved: ${name2}@${meta.version}, workspace=${!!meta.$workspace}, request=${result[name2].request}`);
      } catch {
        logger7.debug(`local dependency not found before metadata fetch: ${name2}, request=${result[name2].request}`);
      }
      const source = classifyDependencySource(result[name2].request, {
        workspace: result[name2].workspace,
        installed: !!result[name2].resolved
      });
      Object.assign(result[name2], source);
      if (!result[name2].local && !(0, import_semver9.valid)(result[name2].request)) {
        result[name2].invalid = true;
        logger7.debug(`dependency request is not exact semver: ${name2}, request=${result[name2].request}`);
      }
      const previous = this.depCache?.[name2];
      const notFound = this.metadata.hasRecentNotFound(name2);
      const preserved = reuseConfirmedDependencySource(
        previous,
        result[name2],
        notFound
      );
      if (preserved) Object.assign(result[name2], preserved);
      if (previous?.latest && previous.request === result[name2].request && previous.resolved === result[name2].resolved) {
        result[name2].latest = previous.latest;
      }
    }
    ...
    logger7.info(`dependency local snapshot ready: total=${names.length}, installed=${installed}, invalid=${invalid}, elapsed=${Date.now() - start}ms`);
    return result;
  }
  async _refreshDependencyMetadata(result = this.depCache, serial = this.metadata.serial) {
    const start = Date.now();
    const names = Object.keys(result);
    const targets = names.filter((name2) => !result[name2].local && !result[name2].invalid);
    logger7.debug(`refresh dependency metadata started: total=${names.length}, targets=${targets.length}, concurrency=${this.config.concurrency ?? 4}, registry=${this.endpoint}, autoRoute=${this.config.autoRoute !== false}`);
    const probeName = pickMetadataProbe(targets);
    if (probeName) await this.metadata.ensureEndpoint(probeName, this.metadata.serial);
    logger7.debug(`refresh dependency metadata route ready: probe=${probeName ?? "-"}, selected=${this.metadata.selectedEndpoint}, configured=${this.endpoint}, probed=${this.metadata.hasRouteProbeResult}`);
    await (0, import_p_map.default)(targets, async (name2) => {
      if (this.isStale(serial)) return;
      try {
        ...
        if (versions) {
          ...
          logger7.debug(`dependency latest resolved: ${name2}, resolved=${result[name2].resolved ?? "-"}, latest=${result[name2].latest}, versions=${Object.keys(versions).length}`);
        } else if (!versions && this.metadata.hasRecentNotFound(name2) && this.markRegistryNotFoundDependency(name2, result[name2])) {
          logger7.debug(`dependency npm not-found result reused from cache: ${name2}`);
        } else {
          logger7.debug(`dependency latest unresolved: ${name2}, resolved=${result[name2].resolved ?? "-"}, request=${result[name2].request}`);
        }
      } catch (error) {
        if (this.isStale(serial)) return;
        const detail = this.formatRegistryError(error);
        if (detail.reason === "not-found" && this.markRegistryNotFoundDependency(name2, result[name2])) {
        } else {
          logger7.debug(`dependency metadata refresh skipped after error: ${name2}, reason=${detail.reason}, error=${detail.error}`);
        }
      }
    }, { concurrency: this.config.concurrency ?? 4 });
    logger7.info(`dependency metadata refresh completed: total=${names.length}, targets=${targets.length}, registry=${this.metadata.selectedEndpoint}, elapsed=${Date.now() - start}ms`);
  ...
  refreshDependencyMetadata(wait = false) {
    if (this.depMetadataFresh) return wait ? Promise.resolve(this.depCache) : void 0;
    if (!this.depTask) {
      const task = this._refreshDependencyMetadata(this.depCache, this.metadata.serial);
      this.depTask = task;
      task.then(() => {
        if (this.depTask === task) this.depTask = void 0;
      }, (error) => {
        if (this.depTask === task) this.depTask = void 0;
        logger7.warn(`dependency metadata refresh failed: ${error instanceof Error ? error.message : error}`);
      });
    }
    return wait ? this.depTask : void 0;
  }
  async probeDependenciesInBackground(reason = "background") {
    const start = Date.now();
    if (this.depTask) {
      logger7.debug(`reuse running dependency metadata task for ${reason} probe`);
      await this.depTask;
      await this.refreshData();
      logger7.info(`dependency ${reason} probe reused running metadata task: elapsed=${Date.now() - start}ms`);
      return;
    }
    ...
    logger7.info(`dependency ${reason} probe started: deps=${Object.keys(this.manifest.dependencies ?? {}).length}`);
    await this.refreshDependencyMetadata(true);
    await this.refreshData();
    logger7.info(`dependency ${reason} probe completed: deps=${Object.keys(this.manifest.dependencies ?? {}).length}, elapsed=${Date.now() - start}ms`);
  }
  getDeps(options = {}) {
  ...
  async refresh(refresh = false, waitMetadata = false) {
    ...
    logger7.info(`dependency refresh requested by console: deps=${Object.keys(this.manifest.dependencies ?? {}).length}, waitMetadata=${waitMetadata}, elapsed=${Date.now() - start}ms`);
  }
  startInstallLog(deps, forced, options = {}, changes = []) {
    return this.installHistory.start(deps, forced, options, changes);
  }
  emitInstallLog(type, line) {
    this.installHistory.emit(type, line);
  }
  finishInstallLog(result) {
    return this.installHistory.finish(result);
  }
  getInstallHistory(limit = 20) {
    return this.installHistory.getHistory(limit);
  }
  getInstallLogDetail(id) {
    return this.installHistory.getDetail(id);
  }
  async getEnvironmentSnapshots() {
    const current = this.installActive ? await this.captureCurrentEnvironmentSnapshot("external") : await this.recordCurrentEnvironmentSnapshot("external");
  ...
  async getEnvironmentSnapshotPreview(id) {
  ...
  async override(deps) {
    const filename = (0, import_path8.resolve)(this.cwd, "package.json");
    logger7.debug(`override package dependencies: file=${filename}, changes=${formatDeps(deps)}`);
    ...
    await import_fs8.promises.writeFile(filename, JSON.stringify(this.manifest, null, 2) + "\n");
    logger7.info(`package dependencies updated: changes=${formatDeps(deps)}, total=${Object.keys(this.manifest.dependencies).length}`);
  }
  async snapshotPackageManifest() {
    const filename = (0, import_path8.resolve)(this.cwd, "package.json");
    const content = await import_fs8.promises.readFile(filename, "utf8");
  ...
  async restorePackageManifest(snapshot, deps, reason) {
    const filename = (0, import_path8.resolve)(this.cwd, "package.json");
    let manifest;
    try {
      manifest = JSON.parse(await import_fs8.promises.readFile(filename, "utf8"));
    } catch {
    ...
    await import_fs8.promises.writeFile(filename, JSON.stringify(manifest, null, 2) + "\n");
    this.manifest = manifest;
    this.depCache = this.getLocalDepsSnapshot();
    this.depMetadataFresh = false;
    logger7.warn(`package dependencies rolled back: reason=${reason}, changes=${formatDeps(deps)}, total=${Object.keys(this.manifest.dependencies ?? {}).length}`);
  }
  _install(options = {}) {
    options ||= {};
    const args = [];
  ...
  _getLocalDeps(override) {
    return (0, import_koishi8.valueMap)(override, (request, name2) => {
      const dep = { request };
      try {
        const meta = loadManifest(name2, this.cwd);
  ...
  async captureCurrentEnvironmentSnapshot(source, operationId) {
    const manifest = await this.snapshotPackageManifest();
    const local = this._getLocalDeps(manifest.dependencies);
    const dependencies = {};
    for (const [name2, request] of Object.entries(manifest.dependencies)) {
      const normalizedRequest = request.replace(/^[~^]/, "");
      dependencies[name2] = {
        request,
        resolved: local[name2]?.resolved,
        workspace: local[name2]?.workspace,
        source: local[name2]?.source,
        local: local[name2]?.local,
        bound: local[name2]?.bound,
        invalid: !local[name2]?.local && !(0, import_semver9.valid)(normalizedRequest)
      };
    }
    return createEnvironmentSnapshot(dependencies, source, operationId);
  }
  async recordCurrentEnvironmentSnapshot(source, operationId) {
  ...
  async _installLocked(deps, forced, beforeReload, options = {}) {
    options ||= {};
    const start = Date.now();
    let resultCode;
    let logResult;
    ...
    await this.recordCurrentEnvironmentSnapshot("external").catch((error) => {
      logger7.warn(`failed to record pre-operation environment snapshot: ${error instanceof Error ? error.message : error}`);
    });
    await this.startInstallLog(deps, forced, options, changes).catch((error) => {
      this.installHistory.resetCurrent();
      logger7.warn(`failed to start dependency install log: ${error instanceof Error ? error.message : error}`);
    });
    logger7.info(`dependency install requested: deps=${formatDeps(deps)}, forced=${!!forced}, installEndpoint=${options.installEndpoint || "(default)"}`);
    try {
      ...
      logger7.debug(`dependency install local state: ${formatLocalDeps(localDeps)}`);
      ...
      if (needsPackageManager) {
        ...
        if (unresolved.length) {
          logger7.info(`resolve possible local plugin sources before package manager: ${unresolved.join(", ")}`);
          const unresolvedErrors = await Promise.all(unresolved.map(async (name2) => {
            try {
              const versions = await this.getPackage(name2);
              if (versions) return;
              if (this.metadata.hasRecentNotFound(name2)) {
                sourceStateChanged = this.markRegistryNotFoundDependency(name2) || sourceStateChanged;
                return;
              }
              return {
                name: name2,
              ...
              return { name: name2, error };
            }
          }));
          const uncertain = unresolvedErrors.filter((item) => {
      ...
      for (const name2 in localDeps) {
        ...
        shouldReload = true;
        logger7.debug(`dependency changed may require full reload: ${name2}, previous=${localDeps[name2]?.resolved ?? "-"}, current=${newDeps[name2]?.resolved ?? "-"}`);
      }
      if (beforeReload) {
        logger7.debug("run pre-reload dependency hook");
        await beforeReload();
      }
      await this.refreshData();
      await this.recordCurrentEnvironmentSnapshot("operation", this.installHistory.currentId).catch((error) => {
        logger7.warn(`failed to record dependency environment snapshot: ${error instanceof Error ? error.message : error}`);
      });
      logger7.info(`dependency install completed: deps=${formatDeps(deps)}, forced=${!!needsPackageManager}, fullReload=${shouldReload}, elapsed=${Date.now() - start}ms`);
      if (shouldReload) {
        this.emitInstallLog("stdout", `full reload scheduled in ${FULL_RELOAD_DELAY}ms`);
        logger7.info(`dependency install triggers full reload after ${FULL_RELOAD_DELAY}ms`);
        setTimeout(() => {
      ...
      await this.finishInstallLog(logResult).catch((error) => {
        logger7.warn(`failed to finish dependency install log: ${error instanceof Error ? error.message : error}`);
      });
    }
  }
  async withInstallLock(description2, callback) {
    const previous = this.installTask;
    let release;
    this.installTask = new Promise((resolve11) => {
      release = resolve11;
    });
    if (this.installActive) logger7.info(`dependency install queued: ${description2}`);
    await previous;
  ...
  async finishLocalPackageUpload(request) {
    ...
    const scripts = Object.keys(result.manifest.scripts ?? {}).filter((name2) => ["preinstall", "install", "postinstall", "prepare"].includes(name2));
    return {
      uploadId: result.uploadId,
      filename: result.filename,
      name: result.manifest.name,
      version: result.manifest.version,
      description: typeof result.manifest.description === "string" ? result.manifest.description : void 0,
      size: result.size,
      hash: result.hash,
      scripts,
      currentRequest,
  ...
  commitLocalPackageUpload(uploadId) {
    return this.localPackageUploads.commit(uploadId);
  }
  cancelLocalPackageUpload(uploadId) {
    return this.localPackageUploads.cancel(uploadId);
  }
  async prepareLocalBinding(name2) {
  ...
  async applyEnvironmentSnapshot(id, options = {}) {
    options ||= {};
    return this.withInstallLock(`environmentSnapshot=${id}`, async () => {
      ...
      logger7.info(`environment snapshot restore requested: target=${id}, changes=${formatDeps(changes)}`);
      return this._installLocked(changes, true, void 0, options);
    });
  }
  isSelfUpdate(deps) {
...
((Installer2) => {
  Installer2.Config = import_koishi8.Schema.object({
    endpoint: import_koishi8.Schema.string().role("link"),
    timeout: import_koishi8.Schema.number().role("time").default(import_koishi8.Time.second * 5),
    autoRoute: import_koishi8.Schema.boolean().default(true),
    retry: import_koishi8.Schema.number().min(0).max(5).step(1).default(1),
    concurrency: import_koishi8.Schema.number().min(1).max(16).step(1).default(4),
    installLogRetentionHours: import_koishi8.Schema.number().min(1).max(24 * 365).step(1).default(72)
  });
})(Installer || (Installer = {}));
...
var import_registry6 = __toESM(require("@koishijs/registry"));

// src/node/market-internals.ts
...
var ROUTE_STAGGER = 80;
var FIRST_PAYLOAD_TIMEOUT = import_koishi9.Time.second * 1.5;
var FAST_ROUTE_THRESHOLD = import_koishi9.Time.second * 0.5;
var MARKET_GENERATION_TOLERANCE = import_koishi9.Time.minute * 2;
var MAX_CACHE_ENTRIES = 3;
var CACHE_ENTRY_TTL = import_koishi9.Time.day * 30;
...
function formatAge(age) {
  ...
  if (age < import_koishi9.Time.second) return `${Math.max(0, Math.round(age))}ms`;
  if (age < import_koishi9.Time.minute) return `${Math.round(age / import_koishi9.Time.second)}s`;
  if (age < import_koishi9.Time.hour) return `${Math.round(age / import_koishi9.Time.minute)}m`;
  if (age < import_koishi9.Time.day) return `${Math.round(age / import_koishi9.Time.hour)}h`;
  return `${Math.round(age / import_koishi9.Time.day)}d`;
}
...
function getMarketGenerationTime(result) {
...
function getRouteCooldown(failures = 0) {
  ...
  if (failures === 1) return import_koishi9.Time.minute;
  if (failures === 2) return import_koishi9.Time.minute * 5;
  if (failures === 3) return import_koishi9.Time.minute * 30;
  if (failures === 4) return import_koishi9.Time.hour * 4;
  return import_koishi9.Time.hour * 12;
}
function formatSnapshot(snapshot = {}) {
  return [
    ...
    `size=${formatBytes2(snapshot.size)}`,
    `wireSize=${formatBytes2(snapshot.wireSize)}`,
...
function formatRouteScores2(routes) {
...
function formatCacheEntries(entries) {
  ...
  return values.map((entry) => [
    ...
    `size=${formatBytes2(entry.size)}`,
    `wireSize=${formatBytes2(entry.wireSize)}`,
...
function isLegacyInlineCacheStore(value) {
  if (!value || typeof value !== "object") return false;
  if (value.version !== 3) return true;
  return Object.values(value.entries ?? {}).some((entry) => Array.isArray(entry?.result?.objects));
}
function normalizePersistedRouteStats(value) {
  ...
  for (const endpoint in value) {
    ...
    result[endpoint] = {
      score: clamp3(score, -6, 3),
      averageElapsed: finiteNumber(stats.averageElapsed),
      lastSuccess: finiteNumber(stats.lastSuccess),
      contentEncoding: typeof stats.contentEncoding === "string" ? stats.contentEncoding : void 0,
...
function hasCacheResultReference(value) {
  return Array.isArray(value?.result?.objects) || typeof value?.file === "string";
}
  ...
  try {
    return await Promise.race([
      ...
      new Promise((resolve11) => {
        timer = setTimeout(() => resolve11(false), timeout);
      })
    ]);
  } finally {
    clearTimeout(timer);
...
// src/node/market-cache.ts
var import_koishi10 = require("koishi");
var import_fs9 = require("fs");
var import_crypto4 = require("crypto");
var import_path9 = require("path");
var MarketDiskCache = class {
  constructor(ctx, config, options) {
    this.ctx = ctx;
    this.config = config;
    this.options = options;
    this.file = (0, import_path9.resolve)(ctx.baseDir, "cache", "market-next-index.json");
    this.directory = (0, import_path9.resolve)(ctx.baseDir, "cache", "market-next-index");
  }
  ctx;
  config;
  options;
  ...
  result;
  writeTimer;
  routeStatsWriteTimer;
  maintenanceTimers = /* @__PURE__ */ new Set();
  get diskMeta() {
  ...
  clearDiskMeta() {
    this.loadedMeta = void 0;
  }
  getConditionalHeaders(endpoint) {
    const meta = this.entries[endpoint] || (this.conditionMeta?.endpoint === endpoint ? this.conditionMeta : void 0);
    if (!meta) return {};
    const headers = {};
  ...
  async load(serial) {
    ...
    try {
      ...
      const content = await import_fs9.promises.readFile(this.file, "utf8");
      ...
      this.options.log("debug", `market disk cache store parsed: bytes=${formatBytes2(Buffer.byteLength(content))}, entries=${Object.keys(store.entries).length}, lastUsed=${store.lastUsed ?? "-"}, parse=${parseElapsed}ms, endpoints=${formatCacheEntries(store.entries)}`);
      const staleEndpoints = Object.values(store.entries).filter((entry2) => !!entry2 && Date.now() - entry2.fetchedAt > CACHE_ENTRY_TTL).map((entry2) => entry2.endpoint);
      if (staleEndpoints.length) {
        this.options.log("debug", `market disk cache has ${staleEndpoints.length} stale entries (>${CACHE_ENTRY_TTL / import_koishi10.Time.day}d), will prune on next write: ${staleEndpoints.join(", ")}`);
      }
  ...
  async loadEntry(entry) {
    if (Array.isArray(entry.result?.objects)) return entry;
    if (!entry.file) return;
    try {
      const content = await import_fs9.promises.readFile((0, import_path9.resolve)(this.directory, entry.file), "utf8");
      const result = JSON.parse(content);
      if (!Array.isArray(result?.objects)) return;
      const cache2 = { ...entry, result };
      this.entries[entry.endpoint] = cache2;
      return cache2;
    } catch (error) {
  ...
  async findByHash(hash, endpoints) {
    for (const endpoint of endpoints) {
      ...
      const cache2 = await this.loadEntry(entry);
      if (!cache2) continue;
      this.options.log("debug", `market cache content hash hit: endpoint=${endpoint}, hash=${shortHash(hash)}, objects=${cache2.result.objects.length}`);
      return cache2;
    }
  }
  async getLatestGeneration(endpoints) {
    ...
    for (const endpoint of endpoints) {
      ...
      if (generation == null) {
        const cache2 = await this.loadEntry(entry);
        generation = getMarketGenerationTime(cache2?.result);
        if (cache2 && generation != null) cache2.generation = generation;
      }
      if (generation != null && (latest == null || generation > latest)) latest = generation;
    }
    return latest;
  }
  scheduleWrite(result, meta = this.conditionMeta) {
    if (!meta) return;
    clearTimeout(this.writeTimer);
    const entry = {
      ...meta,
    ...
    this.entries = cache2.entries;
    this.options.log("debug", `schedule market disk cache write: endpoint=${entry.endpoint}, objects=${result.objects.length}, entries=${Object.keys(cache2.entries).length}, file=${this.file}, hash=${shortHash(entry.hash) ?? "-"}, size=${formatBytes2(entry.size)}, wireSize=${formatBytes2(entry.wireSize)}, encoding=${entry.contentEncoding ?? "identity"}`);
    this.writeTimer = setTimeout(() => {
      this.writeTimer = void 0;
      void this.writeStore(cache2);
    }, 0);
  }
  scheduleRouteStatsWrite() {
    clearTimeout(this.routeStatsWriteTimer);
    this.routeStatsWriteTimer = setTimeout(() => {
      this.routeStatsWriteTimer = void 0;
  ...
  async pick() {
    ...
    const primaryCache = primary ? await this.loadEntry(primary) : void 0;
    if (primaryCache) {
    ...
    const candidates = endpoints.filter((endpoint) => endpoint !== this.config.endpoint).map((endpoint) => this.entries[endpoint]).filter((cache2) => !!cache2 && hasCacheResultReference(cache2)).sort((a, b) => {
    ...
    for (const entry of candidates) {
      const cache2 = await this.loadEntry(entry);
      if (!cache2) continue;
      this.options.log("debug", `pick market disk cache fallback hit: endpoint=${cache2.endpoint}, candidates=${candidates.map((item) => `${item.endpoint} score=${this.getScore(item).toFixed(2)} age=${formatAge(Date.now() - item.fetchedAt)} objects=${item.result?.objects?.length ?? item.objects ?? "-"}`).join(" | ")}`);
      return cache2;
    }
  }
  getScore(cache2) {
    const age = Number.isFinite(cache2.fetchedAt) ? Date.now() - cache2.fetchedAt : Infinity;
    let score = this.options.getRouteScore(cache2.endpoint);
    if (age <= import_koishi10.Time.hour * 12) score += 3;
    else if (age <= import_koishi10.Time.day * 3) score += 1;
    else score -= 1;
    if (cache2.endpoint === this.config.endpoint) score += 0.5;
    return score;
  }
  getEntryFilename(endpoint) {
    return `${(0, import_crypto4.createHash)("sha1").update(endpoint).digest("hex").slice(0, 16)}.json`;
  }
  createSplitEntry(entry) {
  ...
  async writeEntryFile(entry) {
    await import_fs9.promises.mkdir(this.directory, { recursive: true });
    const file = (0, import_path9.resolve)(this.directory, this.getEntryFilename(entry.endpoint));
    const tempFile = `${file}.${process.pid}.${Date.now()}.tmp`;
    await import_fs9.promises.writeFile(tempFile, JSON.stringify(entry.result));
    await import_fs9.promises.rename(tempFile, file);
  }
  async pruneSplitFiles(entries) {
    try {
      const keep = new Set(Object.values(entries).map((entry) => entry?.file).filter(Boolean));
      const files = await import_fs9.promises.readdir(this.directory).catch(() => []);
      await Promise.all(files.filter((file) => file.endsWith(".json") && !keep.has(file)).map((file) => import_fs9.promises.unlink((0, import_path9.resolve)(this.directory, file)).catch(() => {
      })));
    } catch (error) {
      this.options.log("debug", `failed to prune split market cache files: ${formatError(error)}`);
    }
  }
  async writeRouteStats() {
  ...
  pruneEntries(lastUsed) {
    const entries = Object.values(this.entries).filter((cache2) => !!cache2 && hasCacheResultReference(cache2) && Date.now() - cache2.fetchedAt <= CACHE_ENTRY_TTL).sort((a, b) => {
  ...
  async writeStore(cache2) {
    if (!this.options.isActive()) return;
    try {
      await import_fs9.promises.mkdir((0, import_path9.dirname)(this.file), { recursive: true });
      const entries = {};
      for (const [endpoint, entry] of Object.entries(cache2.entries)) {
        if (!entry) continue;
        if (Array.isArray(entry.result?.objects)) {
          await this.writeEntryFile(entry);
          entries[endpoint] = this.createSplitEntry(entry);
        } else if (entry.file) {
      ...
      const tempFile = `${this.file}.${process.pid}.${Date.now()}.tmp`;
      await import_fs9.promises.writeFile(tempFile, nextStore);
      await import_fs9.promises.rename(tempFile, this.file);
      await this.pruneSplitFiles(entries);
      const endpoints = Object.keys(cache2.entries);
      this.options.log("debug", `wrote market disk cache store: entries=${endpoints.length}, lastUsed=${cache2.lastUsed ?? "unknown"}, endpoints=${endpoints.join(", ")}`);
    } catch (error) {
      this.options.log("warn", `failed to write market disk cache: ${formatError(error)}`);
    }
  }
  scheduleMaintenance(delay, callback) {
...
// src/node/market-router.ts
var import_koishi12 = require("koishi");

// src/node/market-fetcher.ts
var import_crypto5 = require("crypto");
var MarketEndpointFetcher = class {
  constructor(ctx, config, cache2, options) {
    this.ctx = ctx;
    this.config = config;
    this.cache = cache2;
    this.options = options;
  ...
  async requestEndpoint(request) {
    ...
    this.options.log("debug", `market response headers: endpoint=${endpoint}, status=${response.status}, request=${requestElapsed}ms, etag=${etag ?? "-"}, lastModified=${lastModified ?? "-"}, encoding=${contentEncoding ?? "identity"}, contentLength=${formatBytes2(headerWireSize)}`);
    return {
  ...
  async reuseNotModified(endpoint, total, start, response, cached) {
    const cache2 = cached && await this.cache.loadEntry(cached);
    if (!cache2) throw new Error(`market index from ${endpoint} returned 304 without cache`);
    const elapsed = Date.now() - start;
    const validatedAt = Date.now();
    this.options.log("debug", `market index not modified from ${endpoint} in ${elapsed}ms, reuse cache hash=${shortHash(cache2.hash) || "unknown"}`);
    this.options.log("info", `market index http-304: endpoint=${endpoint}, elapsed=${elapsed}ms, request=${response.requestElapsed}ms, cachedAt=${formatTime(cache2.fetchedAt)}, hash=${shortHash(cache2.hash) || "unknown"}`);
    return {
      endpoint,
      ...
      size: cache2.size,
      wireSize: response.headerWireSize ?? cache2.wireSize,
      contentEncoding: response.contentEncoding ?? cache2.contentEncoding,
      hash: cache2.hash,
      etag: response.etag || cache2.etag,
      lastModified: response.lastModified || cache2.lastModified,
      cachedAt: cache2.fetchedAt,
      validatedAt
    };
  }
  decodeResponse(endpoint, response, cached) {
    const text = response.text;
    const size = Buffer.byteLength(text);
    const wireSize = normalizeWireSize(response.headerWireSize, size);
    this.options.log("debug", `market response body decoded: endpoint=${endpoint}, chars=${text.length}, decodedSize=${formatBytes2(size)}, wireSize=${formatBytes2(wireSize)}, cachedHash=${shortHash(cached?.hash) ?? "-"}, cachedAt=${cached?.fetchedAt ? formatTime(cached.fetchedAt) : "-"}`);
    const hashStart = Date.now();
    const hash = (0, import_crypto5.createHash)("sha256").update(text).digest("hex");
  ...
  async reuseHashCache(endpoint, total, start, response, decoded, cached) {
    const hashCache = cached && cached.hash === decoded.hash ? await this.cache.loadEntry(cached) : void 0;
    if (!hashCache) return;
    const elapsed = Date.now() - start;
    const validatedAt = Date.now();
    ...
    this.options.log("info", `market index hash-cache: endpoint=${endpoint}, elapsed=${elapsed}ms, request=${response.requestElapsed}ms, hash=${shortHash(decoded.hash)}, size=${formatBytes2(decoded.size)}, wireSize=${formatBytes2(decoded.wireSize)}, encoding=${response.contentEncoding ?? "identity"}`);
    return {
      endpoint,
  ...
  parseNetworkResult(endpoint, total, start, response, decoded) {
    const parseStart = Date.now();
    this.options.log("debug", `market json parse started: endpoint=${endpoint}, decodedSize=${formatBytes2(decoded.size)}`);
    const result = JSON.parse(decoded.text);
    const parseElapsed = Date.now() - parseStart;
    ...
    this.options.log("info", `market index fetched: endpoint=${endpoint}, elapsed=${elapsed}ms, request=${response.requestElapsed}ms, hash=${decoded.hashElapsed}ms, json=${parseElapsed}ms, objects=${result.objects.length}, size=${formatBytes2(decoded.size)}, wireSize=${formatBytes2(decoded.wireSize)}, encoding=${response.contentEncoding ?? "identity"}, hash=${shortHash(decoded.hash) || "unknown"}, version=${result.version ?? "legacy"}`);
    return {
      endpoint,
      result,
      elapsed,
...
// src/node/market-version.ts
var import_koishi11 = require("koishi");
var PRIMARY_DISCOVERY_TIMEOUT = import_koishi11.Time.second * 1.2;
var VERSION_DISCOVERY_TIMEOUT = import_koishi11.Time.second * 3;
var VERSION_HASH_PATTERN = /^[a-f0-9]{64}$/;
var versionedSources = [
...
var versionedSourceMap = new Map(versionedSources.map((source) => [source.endpoint, source]));
function createSource(endpoint, authority, authoritative = false) {
  return {
    endpoint,
...
var MarketVersionResolver = class {
  ...
  config;
  log;
  resolve(endpoints, signal) {
    const availableSources = endpoints.map((endpoint) => getVersionedMarketSource(endpoint)).filter((source) => !!source);
    ...
    const preferredIndex = /* @__PURE__ */ new Map();
    ...
    if (!sources.length) return Promise.resolve(void 0);
    ...
    return new Promise((resolve11, reject) => {
      ...
      const chooseHash = () => [...votes.entries()].sort((a, b) => {
        ...
        const authoritativeDelta = Number(b[1].some((item) => item.authoritative)) - Number(a[1].some((item) => item.authoritative));
      ...
      const finish = (preferredHash) => {
        if (settled) return;
        settled = true;
        cleanup();
        const hash = preferredHash ?? chooseHash();
        if (!hash) return resolve11(void 0);
  ...
  async fetchVersion(source, signal) {
...
// src/node/market-router.ts
var StaleMarketIndexError = class extends Error {
};
var MarketRouter = class {
  constructor(ctx, config, cache2, options) {
    this.ctx = ctx;
    this.config = config;
    this.cache = cache2;
    this.options = options;
    this.fetcher = new MarketEndpointFetcher(ctx, config, cache2, {
  ...
  async fetchDirectIndex(serial, endpoints) {
  ...
  async fetchVersionedIndex(serial, endpoints) {
    ...
    const speculative = hasCache ? void 0 : this.startSpeculativeIndex(serial, versionedEndpoints);
    const controller = this.trackController(new AbortController());
    let resolution;
    try {
    ...
    if (!resolution) {
      if (speculative && !speculative.done) {
        await Promise.race([
          speculative.task,
          new Promise((resolve11) => setTimeout(resolve11, 300))
        ]);
      }
    ...
    if (speculative && !speculative.done) {
      await Promise.race([
        speculative.task,
        new Promise((resolve11) => setTimeout(resolve11, 150))
      ]);
    }
  ...
  startSpeculativeIndex(serial, endpoints) {
    const t4wefan = "https://registry.koishi.t4wefan.pub/index.json";
    const candidates = [endpoints[0], endpoints.includes(t4wefan) ? t4wefan : void 0].filter((endpoint, index, array) => !!endpoint && array.indexOf(endpoint) === index);
    const controller = this.trackController(new AbortController());
    const state = {
      controller,
  ...
  getEndpointCandidates() {
    return [this.config.endpoint, ...this.config.autoRoute === false ? [] : FALLBACK_ENDPOINTS].filter((endpoint, index, array) => !!endpoint && array.indexOf(endpoint) === index);
  }
  getPreferredEndpoint() {
    return this.config.endpoint;
  }
  getScore(endpoint, now = Date.now()) {
    const stats = this.stats[endpoint];
    const cached = this.cache.entries[endpoint];
    let score = endpoint === this.config.endpoint ? 1 : 0;
    if (cached) {
      const age = Date.now() - cached.fetchedAt;
      score += age <= import_koishi12.Time.day ? 1.5 : 0.5;
    }
    return scoreRouteHealth(stats, {
      baseScore: score,
  ...
  getScores(endpoints = this.getEndpointCandidates()) {
    ...
    return endpoints.map((endpoint) => {
      const stats = this.stats[endpoint];
      const cache2 = this.cache.entries[endpoint];
      return {
        endpoint,
  ...
  restoreStats(persisted) {
    for (const [endpoint, stats] of Object.entries(persisted)) {
      if (!stats) continue;
      const hasRecentSuccess = stats.lastSuccess && Date.now() - stats.lastSuccess < import_koishi12.Time.day;
      this.stats[endpoint] = {
        score: hasRecentSuccess ? clamp3(stats.score, -1, 3) : clamp3(stats.score, -4, 3),
        successes: 0,
        failures: 0,
        consecutiveFailures: hasRecentSuccess ? 0 : stats.consecutiveFailures,
        cooldownUntil: hasRecentSuccess ? void 0 : stats.cooldownUntil,
        averageElapsed: stats.averageElapsed,
        lastSuccess: stats.lastSuccess,
        contentEncoding: stats.contentEncoding
      };
  ...
  async fetchIndexFromEndpoints(serial, endpoints, options = {}) {
    const routeMode = options.rescue ? "rescue" : "active";
    this.options.log("debug", `market endpoint candidates (${routeMode}): ${endpoints.join(", ")}`);
    this.options.log("debug", `market route scores before fetch: ${formatRouteScores2(this.getScores(endpoints))}`);
    ...
    if (endpoints.length === 1 || this.config.autoRoute === false) {
      ...
      try {
        const result = await this.fetcher.fetch({
          ...
          requestUrl: options.expectedHash ? getVersionedMarketIndexUrl(endpoints[0], options.expectedHash) : void 0,
    ...
    return new Promise((resolve11, reject) => {
      ...
      const fail = (endpoint, index, error, penalize = true, primaryReason = "primary-failed") => {
        if (settled) return;
      ...
      const startEndpoint = (endpoint, index, waitIndex = 0) => {
        ...
        this.waitRouteTurn(waitIndex, signal).then(() => {
          ...
          return this.fetcher.fetch({
            endpoint,
            requestUrl: options.expectedHash ? getVersionedMarketIndexUrl(endpoint, options.expectedHash) : void 0,
            expectedHash: options.expectedHash,
            index,
            total: endpoints.length,
            serial,
  ...
  getRescueEndpoints(activeEndpoints) {
    if (this.config.autoRoute === false) return [];
  ...
  waitRouteTurn(index, signal) {
    ...
    return new Promise((resolve11, reject) => {
      if (signal?.aborted) return reject(signal.reason);
      const timer = setTimeout(resolve11, index * ROUTE_STAGGER);
      signal?.addEventListener("abort", () => {
        clearTimeout(timer);
        reject(signal.reason);
      }, { once: true });
  ...
  assertGeneration(result, minimumGeneration) {
  ...
  recordSuccess(result) {
    ...
    stats.cooldownUntil = void 0;
    stats.failures = Math.max(0, Math.floor(stats.failures * 0.6));
    stats.score = clamp3(stats.score + (result.elapsed <= FAST_ROUTE_THRESHOLD ? 0.4 : 0.1), -6, 3);
    stats.lastSuccess = Date.now();
  ...
  recordFailure(endpoint, options = {}) {
    ...
    stats.failures++;
    if (options.rescue) {
      stats.score = clamp3(stats.score - 0.25, -10, 3);
      ...
      stats.score = clamp3(stats.score - 1.2, -10, 3);
...
// src/node/market-result.ts
function createMarketResultSnapshot(result, objects) {
  return {
...
var MarketProvider2 = class extends MarketProvider {
  ...
  createScanner() {
    ...
    this.scanner = new import_registry6.default((url, config) => registry.get(url, config));
    return registry;
  }
  ...
  async get() {
    ...
    const progress = this.indexMode === "modern" ? total : this.scanner?.progress ?? current?.progress ?? 0;
    return {
      ...
      error: current?.error ?? (this._error ? formatError(this._error) : void 0),
  ...
  async getSnapshot() {
    ...
    if (!this.scanner) {
      ...
      return this.payload ? { ...this.payload, serverNow: Date.now(), debug: this.getDebugInfo() } : { data: {}, dataVersion: this.dataVersion, failed: 0, total: 0, progress: 0, serverNow: Date.now(), debug: this.getDebugInfo() };
    }
    if (this._error) {
  ...
  applyIndex(result, endpoint, contentHash) {
  ...
  applyEndpointResult(result, startedAt, options) {
    ...
    if (options.invalidatePayload) this.payload = void 0;
  ...
  warmDiskCache(reason) {
    if (this.warmDiskCacheTask) return this.warmDiskCacheTask;
    const serial = this.serial;
    this.createScanner();
    this.warmDiskCacheTask = this.loadDiskCache(serial).then((loaded) => {
      if (loaded) {
      ...
      if (this.warmDiskCacheTask) this.warmDiskCacheTask = void 0;
    });
    return this.warmDiskCacheTask;
  }
  async loadDiskCache(serial) {
    try {
  ...
  async probeIndexInBackground(serial, reason) {
    const start = Date.now();
  ...
  async probeInBackground(reason = "idle probe") {
    ...
    if (!this.hasCurrentMarketData() && !this.backgroundTask) {
      const serial2 = ++this.serial;
      this.router.abortPendingRequests(`${reason} market probe superseded`);
      return this.probeIndexInBackground(serial2, reason);
    }
    const serial = this.serial;
  ...
  updateDebugInfo(info, phase) {
    ...
    this.log("debug", `market route scores: ${formatRouteScores2(this.debugInfo.routeScores)}`);
  }
  ...
  log(level, message) {
    ...
    const logger8 = this.ctx.logger("market");
    if (level === "debug") {
      logger8.info(`[debug] ${message}`);
    } else {
      logger8[level](message);
    }
  }
};
((MarketProvider3) => {
  MarketProvider3.Config = import_koishi13.Schema.object({
    endpoint: import_koishi13.Schema.string().role("link").default(DEFAULT_ENDPOINT),
    timeout: import_koishi13.Schema.number().role("time").default(import_koishi13.Time.second * 30),
    proxyAgent: import_koishi13.Schema.string().role("link"),
    autoRoute: import_koishi13.Schema.boolean().default(true),
    logLevel: import_koishi13.Schema.union(logLevels.map((level) => import_koishi13.Schema.const(level))).default("warn")
  });
...
// src/node/chatluna-search.ts
var import_koishi14 = require("koishi");
var import_zod = __toESM(require("zod"));
var CHATLUNA_TOOL_NAME = "koishi_plugin_market_search";
var DAY = import_koishi14.Time.day;
...
var sortValues = ["relevance", "downloads", "created", "updated"];
...
function normalizeInput(input) {
  ...
  return {
    ...
    limit: clamp4(input.limit ?? 10, 1, 50),
...
// src/node/chatluna.ts
var CACHE_TTL = import_koishi15.Time.minute * 10;
var cache = {};
var pending = {};
...
function applyChatLunaTool(ctx, config = {}) {
  ...
  const logger8 = ctx.logger("market");
  logger8.debug("ChatLuna market search tool is enabled; waiting for chatluna service");
  ctx.inject(["chatluna"], (ctx2) => {
    ...
    ctx2.effect(() => {
      ...
      try {
        ...
        ctx2.logger("market").info(`ChatLuna market search tool registered: ${CHATLUNA_TOOL_NAME}`);
        return () => {
          ctx2.logger("market").debug(`ChatLuna market search tool disposed: ${CHATLUNA_TOOL_NAME}`);
          dispose?.();
        };
      } catch (error) {
        ctx2.logger("market").warn(`Failed to register ChatLuna market search tool: ${formatError3(error)}`);
        return () => {
        };
      }
    });
...
async function loadIndex(ctx, config) {
  ...
  try {
    ...
    if (cached) {
      return { index: cached, stale: true, error: formatError3(error) };
    }
    throw error;
  } finally {
...
async function fetchIndex(ctx, config) {
  ...
  const http = ctx.http.extend({
    endpoint,
    timeout: config.search?.timeout ?? import_koishi15.Time.second * 30,
...
var AVATAR_CACHE_TTL = import_koishi16.Time.day * 7;
var AVATAR_CACHE_SWEEP_INTERVAL = import_koishi16.Time.hour;
var AVATAR_MAX_ENTRIES = 512;
var AVATAR_MAX_SIZE = 96 * 1024;
var AVATAR_BLOCKED_HOSTS = /* @__PURE__ */ new Set(["localhost", "localhost.localdomain"]);
var AVATAR_ALLOWED_HOSTS = /* @__PURE__ */ new Set(["www.npmjs.com", "npmjs.com", "s.gravatar.com", "gravatar.com", "www.gravatar.com", "cravatar.cn", "www.cravatar.cn"]);
var AVATAR_DEFAULT_HINTS = /* @__PURE__ */ new Set(["default", "mp", "identicon", "monsterid", "wavatar", "retro", "robohash", "blank"]);
var AVATAR_FETCH_TIMEOUT = 3e3;
var AVATAR_HEAD_TIMEOUT = 1200;
var AVATAR_MAX_REDIRECTS = 3;
var AVATAR_ACCEPT = "image/avif,image/webp,image/png,image/jpeg,image/gif,image/svg+xml;q=0.8,*/*;q=0.1";
var avatarDiskCleanupTask;
...
function cleanupAvatarCaches(ctx) {
  cleanupAvatarCache();
  void cleanupAvatarDiskCache(ctx);
}
function getAvatarCacheDir(ctx) {
  return (0, import_path10.resolve)(ctx.baseDir, "cache", "market-next-avatars");
}
function normalizeAvatarCacheKey(key) {
  return key.replace(/[^0-9A-Za-z:@._-]/g, "-").slice(0, 128) || `url:${(0, import_crypto6.createHash)("sha1").update(key).digest("hex")}`;
}
function getAvatarCacheFile(ctx, key) {
  return (0, import_path10.resolve)(getAvatarCacheDir(ctx), `${(0, import_crypto6.createHash)("sha1").update(normalizeAvatarCacheKey(key)).digest("hex")}.json`);
}
function normalizeAvatarDiskCache(value, key) {
  if (!value || typeof value !== "object") return;
...
async function readAvatarDiskCache(ctx, key) {
  try {
    const file = getAvatarCacheFile(ctx, key);
    const entry = normalizeAvatarDiskCache(JSON.parse(await import_fs10.promises.readFile(file, "utf8")), key);
    if (!entry) {
      void import_fs10.promises.unlink(file).catch(() => {
      });
      return;
    }
...
async function writeAvatarDiskCache(ctx, key, url, result) {
  try {
    await import_fs10.promises.mkdir(getAvatarCacheDir(ctx), { recursive: true });
    const file = getAvatarCacheFile(ctx, key);
    const tempFile = `${file}.${process.pid}.${Date.now()}.tmp`;
    const entry = {
      key,
...
async function cleanupAvatarDiskCache(ctx) {
  ...
  avatarDiskCleanupTask = (async () => {
    try {
      ...
      const alive = entries.filter((entry) => !!entry).sort((a, b) => b.cachedAt - a.cachedAt);
      await Promise.all(alive.slice(AVATAR_MAX_ENTRIES).map((entry) => import_fs10.promises.unlink(entry.path).catch(() => {
      })));
    } finally {
      avatarDiskCleanupTask = void 0;
    }
  })();
  return avatarDiskCleanupTask;
}
async function clearAvatarCacheStorage(ctx) {
  const memory = avatarCache.size;
  avatarCache.clear();
  if (avatarDiskCleanupTask) await avatarDiskCleanupTask.catch(() => {
  });
  const dir = getAvatarCacheDir(ctx);
  const files = await import_fs10.promises.readdir(dir).catch((error) => {
    if (error?.code === "ENOENT") return [];
    throw error;
  });
  const disk = files.filter((file) => file.endsWith(".json")).length;
  await import_fs10.promises.rm(dir, { recursive: true, force: true });
  return { memory, disk };
}
async function fetchAvatar(ctx, rawKey, rawUrl) {
...
async function checkAvatarHead(ctx, url) {
  let current = url;
...
async function fetchAvatarResponse(ctx, url) {
  let current = url;
  for (let index = 0; index <= AVATAR_MAX_REDIRECTS; index++) {
...
function isAvatarRedirect(status) {
  return status >= 300 && status < 400;
}
async function resolveAvatarRedirect(base, location) {
  if (!location) return;
  let next;
  try {
...
async function readLimitedAvatarBody(stream) {
...
async function cancelAvatarBody(stream) {
  await stream?.cancel?.().catch(() => {
  });
}
function isAvatarCacheLikelyDefault(url, key) {
  try {
...
function getAvatarDefaultMode(url) {
...
function isAvatarDefaultResponse(headers) {
  const from = headers.get("avatar-from")?.trim().toLowerCase();
  return from === "default" || from === "mp";
}
async function isBlockedAvatarTarget(url) {
  ...
  const directIp = (0, import_net.isIP)(hostname);
  if (directIp) return isPrivateAddress(hostname, directIp);
  try {
    const records = await (0, import_promises2.lookup)(hostname, { all: true, verbatim: false });
...
function normalizeAvatarHostname(hostname) {
  return hostname.toLowerCase().replace(/^\[(.*)\]$/, "$1").replace(/\.$/, "");
}
function isPrivateAddress(address, family = (0, import_net.isIP)(address)) {
  if (family === 4) {
  ...
  if (family === 6) {
    ...
    return value === "::1" || value === "::" || value.startsWith("::ffff:") || Number.isFinite(first) && (first & 65472) === 65152 || value.startsWith("fc") || value.startsWith("fd") || value.startsWith("ff");
  }
  return true;
}
function startAvatarCacheMaintenance(ctx) {
  void cleanupAvatarDiskCache(ctx);
...
var import_registry7 = __toESM(require("@koishijs/registry"));
var SELF_PACKAGE2 = "koishi-plugin-market-next";
...
function findPluginConfig(plugins, shortname, group) {
  for (const key in plugins || {}) {
    if (key.startsWith("$")) continue;
    const value = plugins[key];
    const [prefix] = key.split(":", 1);
    const name2 = prefix.replace(/^~/, "");
    if (name2 === shortname) return { key, parent: plugins, inGroup: !!group && plugins === group, value };
    if (name2 === "group") {
...
function hasPluginConfigInGroup(plugins, shortname) {
  for (const key in plugins || {}) {
    if (key.startsWith("$")) continue;
    const [prefix] = key.split(":", 1);
    const name2 = prefix.replace(/^~/, "");
...
function isPluginBundleDependency(name2) {
  if (isBundlePackageName(name2)) return true;
  try {
    const meta = loadManifest(name2);
    return !!parseBundleManifest(meta.koishi?.bundle) || meta.keywords?.some((keyword) => keyword.toLowerCase() === BUNDLE_KEYWORD);
  } catch {
    return false;
  }
}
...
async function ensurePluginConfig(ctx, name2, write = true) {
  if (!import_registry7.default.isPlugin(name2)) return false;
  if (name2 === SELF_PACKAGE2) return false;
  if (isPluginBundleDependency(name2)) {
    ctx.logger("market").debug(`skip default config entry for plugin bundle: ${name2}`);
    return false;
  }
...
async function ensurePluginConfigs(ctx, names) {
  ...
  let changed = false;
  let checked = 0;
  for (const name2 of names.filter((name3) => import_registry7.default.isPlugin(name3))) {
    if (!ctx.scope.isActive) return false;
    if (await ensurePluginConfig(ctx, name2, false)) changed = true;
    if (++checked % 20 === 0) await sleep2(0);
  }
...
async function ensureInstalledPluginConfigs(ctx) {
  ...
  const names = Object.keys(manifest.dependencies ?? {}).filter((name2) => import_registry7.default.isPlugin(name2)).filter((name2) => !isPluginBundleDependency(name2));
  const missing = names.filter((name2) => !hasPluginConfig(ctx.loader.config?.plugins, getPluginShortname(name2)));
...
function getBundleGroup(ctx, packageName) {
  const plugins = ctx.loader.config?.plugins;
  if (!plugins) return;
...
function ensureBundleGroup(ctx, packageName, bundle) {
  const plugins = ctx.loader.config?.plugins;
  if (!plugins || !ctx.loader.writable) return;
  ...
  if (plugins[key].$collapsed === void 0) {
    plugins[key].$collapsed = false;
    changed = true;
  }
  return { key, plugins: plugins[key], changed };
}
async function removeBundleConfigs(ctx, request) {
  ...
  const memberNames = new Set((request.members ?? []).map((member) => getPluginShortname(member.plugin || member.package)).filter(Boolean));
...
// src/node/commands.ts
function setupCommands(ctx, config, getActiveDataStore) {
  ctx.i18n.define("zh-CN", require_message_zh_CN());
  ctx.i18n.define("en-US", require_message_en_US());
  ctx.command("plugin.install <name>", { authority: 4 }).alias(".i").action(async ({ session }, name2) => {
    if (!name2) return session.text(".expect-name");
    const names = ctx.installer.resolveName(name2);
    ...
    ctx.loader.envData.message = {
      ...(0, import_koishi18.pick)(session, ["sid", "channelId", "guildId", "isDirect"]),
      content: session.text(".success")
    };
    try {
      await ctx.installer.install(result, void 0, () => ensurePluginConfigs(ctx, Object.keys(result)));
  ...
  ctx.command("plugin.uninstall <name>", { authority: 4 }).alias(".r").action(async ({ session }, name2) => {
    if (!name2) return session.text(".expect-name");
    const names = ctx.installer.resolveName(name2);
    const deps = await ctx.installer.getDeps();
    name2 = names.find((name3) => deps[name3]);
    if (!name2) return session.text(".not-installed");
    await ctx.installer.install({ [name2]: null });
    return session.text(".success");
  });
  ctx.command("plugin.upgrade [name...]", { authority: 4 }).alias(".update", ".up").option("self", "-s, --koishi").option("force", "-f, --force").action(async ({ session, options }, ...names) => {
    await ctx.installer.refresh(true, true);
    const deps = await ctx.installer.getDeps({ background: false });
    const requested = names.length ? names.map((name2) => {
      const candidates = ctx.installer.resolveName(name2);
      return candidates.find((candidate) => deps[candidate]);
    }).filter(Boolean) : Object.keys(deps);
    if (options.self && !requested.includes("koishi")) requested.push("koishi");
    const activeDataStore = getActiveDataStore();
    const runtimeData = activeDataStore ? await activeDataStore.get() : await readMarketDataStore(ctx);
    const policy = {
    ...
    const now = Date.now();
    const updates = Array.from(new Set(requested)).flatMap((name2) => {
      const dep = deps[name2];
      if (!dep?.resolved || dep.local || dep.workspace || dep.invalid) return [];
      const versions = Object.keys(ctx.installer.fullCache[name2] ?? {});
      if (!versions.length && dep.latest) versions.push(dep.latest);
      const target = options.force ? getUpdateCandidates(versions, dep.resolved)[0] : getLatestAllowedUpdate(name2, versions, dep.resolved, policy, now);
      return target ? [{ name: name2, resolved: dep.resolved, target }] : [];
    });
    if (!updates.length) return session.text(".all-updated");
    const output = updates.map(({ name: name2, resolved, target }) => {
      return `${name2}: ${resolved} -> ${target}`;
    });
    ...
    const installDeps = updates.reduce((result2, update) => {
      result2[update.name] = update.target;
      return result2;
    }, {});
    try {
      const code = await ctx.installer.install(installDeps, void 0, () => ensurePluginConfigs(ctx, installNames));
...
// src/node/idle-probe.ts
var import_koishi19 = require("koishi");
function setupIdleProbe(ctx, config) {
  ...
  const getClientCount = () => {
    const clients = ctx.console.clients;
    if (!clients) return 0;
  ...
  const getDelay = () => Math.max(0, config.idleProbeDelay ?? import_koishi19.Time.minute * 5);
  const getBootDelay = () => Math.max(0, config.idleProbeBootDelay ?? import_koishi19.Time.minute);
  const getInterval = () => Math.max(0, config.idleProbeInterval ?? import_koishi19.Time.hour * 6);
  const runProbe = async () => {
    clearIdleTimer();
    if (!ctx.scope.isActive) return;
    if (getClientCount()) return;
    if (ctx.installer.isInstalling) {
      logger8.debug("skip idle background probe because dependency install is active");
      schedule(getDelay());
      return;
    }
    ...
    const retryWait = lastFailure ? Math.min(import_koishi19.Time.minute * 5, getInterval()) - (Date.now() - lastFailure) : 0;
    if (!lastProbe && retryWait > 0) {
      logger8.debug(`skip idle background probe because retry gate is active: remaining=${retryWait}ms`);
      schedule(retryWait);
      return;
    }
    const intervalWait = lastProbe ? getInterval() - (Date.now() - lastProbe) : 0;
    if (intervalWait > 0) {
      logger8.debug(`skip idle background probe because interval gate is active: remaining=${intervalWait}ms`);
    ...
    logger8.info(`idle background probe started: clients=0, delay=${getDelay()}ms, interval=${getInterval()}ms`);
    try {
      ...
      const succeeded = depsResult.status === "fulfilled" && depsResult.value === true || marketResult.status === "fulfilled" && marketResult.value !== false;
      if (succeeded) {
        lastProbe = Date.now();
        lastFailure = 0;
        logger8.info(`idle background probe completed: elapsed=${Date.now() - probeStartedAt}ms`);
      } else {
        lastFailure = Date.now();
        const reason = depsResult.status === "rejected" ? depsResult.reason : marketResult.status === "rejected" ? marketResult.reason : "no probe result";
        logger8.warn(`idle background probe failed: ${reason instanceof Error ? reason.message : reason}`);
      }
    } catch (error) {
      lastFailure = Date.now();
      logger8.warn(`idle background probe failed: ${error instanceof Error ? error.message : error}`);
    } finally {
      running = false;
      if (!getClientCount()) schedule(lastProbe ? getInterval() : Math.min(import_koishi19.Time.minute * 5, getInterval()));
    }
  };
  const schedule = (delay = getDelay()) => {
    ...
    logger8.debug(`idle background probe scheduled: delay=${Math.max(0, delay)}ms`);
  };
  ctx.on("console/connection", () => {
    if (getClientCount()) {
      clearIdleTimer();
      logger8.debug(`idle background probe cancelled: clients=${getClientCount()}`);
    } else {
      schedule();
    }
  });
...
// src/node/console-listeners.ts
var import_p_map2 = __toESM(require("p-map"));

// src/node/config.ts
var import_koishi20 = require("koishi");
var MarketSilentRuleType = import_koishi20.Schema.union([
  import_koishi20.Schema.const("preview").description("\u72B6\u6001\uFF1A\u9884\u89C8\u7248\u63D2\u4EF6"),
  import_koishi20.Schema.const("insecure").description("\u72B6\u6001\uFF1A\u4E0D\u5B89\u5168\u63D2\u4EF6"),
  import_koishi20.Schema.const("bundle").description("\u72B6\u6001\uFF1A\u63D2\u4EF6\u5305"),
  import_koishi20.Schema.const("created-before").description("\u521B\u5EFA\u65F6\u95F4\uFF1A\u65E9\u4E8E\u6307\u5B9A\u65E5\u671F"),
  import_koishi20.Schema.const("created-after").description("\u521B\u5EFA\u65F6\u95F4\uFF1A\u665A\u4E8E\u6307\u5B9A\u65E5\u671F"),
  import_koishi20.Schema.const("updated-before").description("\u66F4\u65B0\u65F6\u95F4\uFF1A\u65E9\u4E8E\u6307\u5B9A\u65E5\u671F"),
  import_koishi20.Schema.const("updated-after").description("\u66F4\u65B0\u65F6\u95F4\uFF1A\u665A\u4E8E\u6307\u5B9A\u65E5\u671F"),
  import_koishi20.Schema.const("created-within").description("\u521B\u5EFA\u65F6\u95F4\uFF1A\u6700\u8FD1 N \u5929\u5185"),
  import_koishi20.Schema.const("updated-within").description("\u66F4\u65B0\u65F6\u95F4\uFF1A\u6700\u8FD1 N \u5929\u5185"),
  import_koishi20.Schema.const("custom").description("\u81EA\u5B9A\u4E49\u9AD8\u7EA7\u6761\u4EF6")
]);
var MarketSilentRules = import_koishi20.Schema.array(import_koishi20.Schema.object({
  type: MarketSilentRuleType.default("preview").description("\u89C4\u5219\u7C7B\u578B"),
  value: import_koishi20.Schema.string().default("").description("\u89C4\u5219\u503C\u3002\u72B6\u6001\u7C7B\u7559\u7A7A\uFF1B\u65E5\u671F\u7C7B\u586B\u5199 YYYY-MM-DD\uFF0C\u4F8B\u5982 2024-01-01\uFF1B\u6700\u8FD1 N \u5929\u586B\u5199\u6570\u5B57\uFF0C\u4F8B\u5982 30\uFF1B\u81EA\u5B9A\u4E49\u89C4\u5219\u586B\u5199\u641C\u7D22\u6761\u4EF6\uFF0C\u4F8B\u5982 category:adapter\u3002"),
  note: import_koishi20.Schema.string().default("").description("\u5907\u6CE8"),
  enabled: import_koishi20.Schema.boolean().default(true).description("\u662F\u5426\u542F\u7528")
...
var Config = import_koishi20.Schema.object({
  frontendMode: import_koishi20.Schema.union([
    import_koishi20.Schema.const("performance").description("\u6027\u80FD\u6A21\u5F0F"),
    import_koishi20.Schema.const("polished").description("\u7CBE\u81F4\u6A21\u5F0F")
  ]).role("radio").default("performance").description("Frontend display mode."),
  depsLayout: import_koishi20.Schema.union([
    import_koishi20.Schema.const("grid").description("\u7F51\u683C"),
    import_koishi20.Schema.const("list").description("\u5217\u8868")
  ]).role("radio").default("grid").description("Dependencies page layout."),
  idleProbe: import_koishi20.Schema.boolean().default(true).description("Run dependency and market metadata probes while Console is idle."),
  idleProbeDelay: import_koishi20.Schema.number().role("time").default(import_koishi20.Time.minute * 5).description("How long Console must stay idle before the background probe starts."),
  idleProbeBootDelay: import_koishi20.Schema.number().role("time").default(import_koishi20.Time.minute).description("Minimum delay after startup before idle probing is allowed."),
  idleProbeInterval: import_koishi20.Schema.number().role("time").default(import_koishi20.Time.hour * 6).description("Minimum interval between idle background probes."),
  bulkMode: import_koishi20.Schema.boolean().default(false).hidden().description("Batch operation mode for dependency changes."),
  removeConfig: import_koishi20.Schema.union([
    import_koishi20.Schema.const(void 0).description("Ask every time"),
    import_koishi20.Schema.const(true).description("Always remove plugin config"),
    import_koishi20.Schema.const(false).description("Never remove plugin config")
  ]).hidden().description("Whether to remove existing plugin config when uninstalling a plugin."),
  updateIgnoredPackages: import_koishi20.Schema.string().role("textarea").hidden().description("Dependency package names that should not be checked for updates. One package per line, or separated by commas."),
  updateIgnoreDuration: import_koishi20.Schema.number().role("time").default(0).hidden().description("Default duration for ignoring one update. 0 means no time-based expiry."),
  updateIgnoreVersions: import_koishi20.Schema.number().min(1).max(20).step(1).default(1).hidden().description("How many consecutive newer versions should be ignored after ignoring one update."),
  updateIgnorePrerelease: import_koishi20.Schema.boolean().default(false).hidden().description("Ignore alpha, beta, rc and other prerelease versions when checking updates."),
  collapsedGroups: import_koishi20.Schema.dict(Boolean).hidden(),
  registry: installer_default.Config,
  search: market_default.Config,
  chatlunaTool: import_koishi20.Schema.boolean().default(false).description("Enable the ChatLuna plugin market query tool. Requires ChatLuna to be installed and enabled separately."),
  marketSilentFilters: import_koishi20.Schema.string().role("textarea").hidden().description("Legacy permanent silent filters."),
  marketSilentStatusRules: import_koishi20.Schema.array(import_koishi20.Schema.any()).hidden(),
  marketSilentDateRules: import_koishi20.Schema.array(import_koishi20.Schema.any()).hidden(),
  marketSilentRecentRules: import_koishi20.Schema.array(import_koishi20.Schema.any()).hidden(),
  marketSilentCustomRules: import_koishi20.Schema.array(import_koishi20.Schema.any()).hidden(),
  marketSilentRules: MarketSilentRules
}).i18n({
  "zh-CN": require_schema_zh_CN(),
  "en-US": require_schema_en_US()
});
var configPatchKeys = [
  "frontendMode",
  "depsLayout",
...
var configReloadKeys = /* @__PURE__ */ new Set([
  "idleProbe",
  "idleProbeDelay",
  "idleProbeBootDelay",
  "idleProbeInterval"
]);
function findMarketNextConfigNode(plugins, currentConfig) {
  let fallback;
  for (const key in plugins || {}) {
    if (key.startsWith("$")) continue;
    const value = plugins[key];
    ...
    const [name2] = normalized.split(":", 1);
    if (value === currentConfig || name2 === "market-next" || name2 === "koishi-plugin-market-next") {
...
function ensureMarketNextConfigDefaults(ctx, currentConfig) {
...
function removeLegacyCollapsedGroupsConfig(ctx, currentConfig) {
  const target = findMarketNextConfigNode(ctx.loader.config?.plugins, currentConfig);
...
async function updateMarketNextConfig(ctx, currentConfig, patch) {
  const target = findMarketNextConfigNode(ctx.loader.config?.plugins, currentConfig);
  if (!target) return false;
  const changedKeys = [];
  let accepted = false;
  for (const key of configPatchKeys) {
    if (!Object.prototype.hasOwnProperty.call(patch, key)) continue;
    accepted = true;
    const value = key === "marketSilentRules" ? normalizeMarketSilentRules(patch[key]) : patch[key];
...
function normalizeMarketSilentRules(value) {
  if (!Array.isArray(value)) return [];
  return value.filter((rule) => !!rule && typeof rule === "object").map((rule) => {
    const normalized = {
      type: rule.type,
...
function normalizeMarketSilentRuleValue(rule) {
...
function findPluginParentContext(ctx, plugins) {
  if (!ctx) return;
  if (ctx.scope.config === plugins) return ctx;
  const record = ctx.scope[/* @__PURE__ */ Symbol.for("koishi.loader.record")];
...
// src/node/bundle-installer.ts
var import_semver10 = require("semver");
async function assertNoDirectBundleCycles(ctx, packageName, members) {
  ...
  for (const member of members) {
    try {
      ...
      const version = (0, import_semver10.maxSatisfying)(versions, member.version, { includePrerelease: true });
      if (!version) continue;
      const remote = registry.versions?.[version];
      const bundle = parseBundleManifest(remote?.koishi?.bundle);
...
async function installBundle(ctx, dataStore, request, forced, options = {}) {
  options ||= {};
  const start = Date.now();
...
${member.plugin}`, member]));
  const selected = manifest.members.map((member) => {
...
${member.plugin}`);
  ...
  const deps = { [request.package]: request.version };
  ...
  const writeBundleConfigs = async () => {
    ...
    for (const member of selected) {
      ...
      if (existing && existing.parent !== group.plugins && member.move) {
        const ident2 = getBundleMemberIdent(request.package, member);
        const fallbackKey = `~${shortname}:${ident2}`;
...
// src/node/market-snapshot.ts
var import_crypto7 = require("crypto");
var import_util = require("util");
var import_zlib = require("zlib");
var gzip = (0, import_util.promisify)(import_zlib.gzip);
var MAX_MARKET_SNAPSHOTS = 6;
var EMPTY_MARKET_DATA = {};
var MarketSnapshotTransport = class {
  ...
  clear() {
    this.tasks.clear();
    this.entries.clear();
    this.memos = /* @__PURE__ */ new WeakMap();
  }
  async prepare(data) {
    const json = JSON.stringify(data);
    const id = (0, import_crypto7.createHash)("sha256").update(json).digest("hex");
  ...
  async encode(id, json) {
    const start = Date.now();
    const decodedSize = Buffer.byteLength(json);
    const body = await gzip(Buffer.from(json), { level: 6 });
...
function normalizeMarketLookupValues(values, limit) {
  if (!Array.isArray(values)) return [];
  return Array.from(new Set(values.filter((value) => typeof value === "string").map((value) => value.trim()).filter((value) => value && value.length <= 214))).slice(0, limit);
}
async function lookupMarket(provider, request = {}) {
  ...
  const result = {
    data: {},
    services: Object.fromEntries(services.map((name2) => [name2, []]))
  };
  ...
  for (const name2 of names) {
    if (data[name2]) result.data[name2] = data[name2];
  }
...
// src/node/console-listeners.ts
var SELF_PACKAGE3 = "koishi-plugin-market-next";
function setupConsoleListeners(ctx, config, dataStore, marketSnapshotTransport) {
  ctx.console.addListener("market/install", async (deps, forced, options) => {
    options ||= {};
    const installNames = Object.entries(deps).filter(([, version]) => version).map(([name2]) => name2).filter((name2) => name2 !== SELF_PACKAGE3);
    const code = await ctx.installer.install(deps, forced, installNames.length ? () => ensurePluginConfigs(ctx, installNames) : void 0, options);
    if (!code) {
      await ensurePluginConfigs(ctx, installNames);
    }
    await Promise.all([
  ...
  ctx.console.addListener("market/prepare-local-binding", async (name2) => {
    return ctx.installer.prepareLocalBinding(name2);
  }, { authority: 4 });
  ...
  ctx.console.addListener("market/package", async (name2) => {
    return ctx.installer.getRegistry(name2);
  }, { authority: 4 });
  ctx.console.addListener("market/index", async (request) => {
    const snapshot = await ctx.console.services.market?.getSnapshot?.();
    if (!snapshot || request?.transport !== "http-gzip") return snapshot;
  ...
  ctx.console.addListener("market/registry", async (names) => {
    const entries = await (0, import_p_map2.default)(names, async (name2) => {
      try {
        const meta = await ctx.installer.getPackage(name2);
        if (!meta) return;
        return [name2, meta];
      } catch (error) {
        ctx.logger("market").debug(`skip registry metadata for ${name2}: ${error instanceof Error ? error.message : error}`);
      }
    }, { concurrency: ctx.installer.config.concurrency ?? 4 });
    return Object.fromEntries(entries.filter(Boolean));
  }, { authority: 4 });
  ctx.console.addListener("market/ensure-config", async (name2) => {
    return ensurePluginConfig(ctx, name2);
  }, { authority: 4 });
...
function apply(ctx, config = {}) {
  ...
  if (ensureMarketNextConfigDefaults(ctx, config)) {
    ...
    void ctx.loader.writeConfig(true).then(() => ctx.get("console")?.refresh("config")).catch((error) => ctx.logger("market").warn(error));
  }
  applyChatLunaTool(ctx, config);
  let activeDataStore;
  ctx.plugin(installer_default, config.registry ?? {});
  ctx.inject(["installer"], (ctx2) => {
    setupCommands(ctx2, config, () => activeDataStore);
  });
  ctx.inject(["console", "installer", "server"], (ctx2) => {
    ctx2.plugin(DependencyProvider);
    ctx2.plugin(RegistryProvider);
    ctx2.plugin(RegistryStatusProvider);
    const dataStore = new MarketDataStore(ctx2);
    activeDataStore = dataStore;
    ctx2.effect(() => () => {
      if (activeDataStore === dataStore) activeDataStore = void 0;
    });
    ctx2.plugin(market_default, config.search ?? {});
    setupIdleProbe(ctx2, config);
    ctx2.console.addEntry({
      dev: (0, import_path11.resolve)(__dirname, "../../client/index.ts"),
      prod: (0, import_path11.resolve)(__dirname, "../../dist")
    });
    const uiPath = String(ctx2.console.config?.uiPath ?? "").replace(/\/+$/, "");
    const marketSnapshotRoute = `${uiPath}/market-next/snapshot`;
    const marketSnapshotTransport = new MarketSnapshotTransport(ctx2, marketSnapshotRoute);
    const server = ctx2.server;
    server.get(`${marketSnapshotRoute}/:id`, (koa) => {
    ...
    ctx2.effect(() => () => marketSnapshotTransport.clear());
    setupConsoleListeners(ctx2, config, dataStore, marketSnapshotTransport);
    ctx2.on("ready", () => {
      void dataStore.migrateFromConfig(config).then(() => {
        if (!removeLegacyCollapsedGroupsConfig(ctx2, config)) return;
        return ctx2.loader.writeConfig(true).then(() => ctx2.get("console")?.refresh("config"));
      }).catch((error) => ctx2.logger("market").warn(`failed to migrate market-next data: ${error instanceof Error ? error.message : error}`));
      const timer = setTimeout(() => {
        if (!ctx2.scope.isActive) return;
        ctx2.logger("market").debug("schedule installed plugin config repair after market-next ready");
        void ensureInstalledPluginConfigs(ctx2).catch((error) => ctx2.logger("market").warn(error));
      }, 1e3);
      const stopAvatarMaintenance = startAvatarCacheMaintenance(ctx2);
      ctx2.effect(() => () => {
        clearTimeout(timer);
