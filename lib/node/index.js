...
var require_schema_zh_CN = __commonJS({
  "src/node/locales/schema.zh-CN.yml"(exports2, module2) {
    module2.exports = { registry: { $description: "\u63D2\u4EF6\u6E90\u8BBE\u7F6E", endpoint: "\u63D2\u4EF6\u7684\u4E0B\u8F7D\u6E90\u3002\u9ED8\u8BA4\u8DDF\u968F\u5F53\u524D\u9879\u76EE\u7684 npm config\u3002", timeout: "\u83B7\u53D6\u63D2\u4EF6\u6570\u636E\u7684\u8D85\u65F6\u65F6\u95F4\u3002", autoRoute: "\u5F53\u524D\u4E0B\u8F7D\u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528 npm \u6E90\u3002", retry: "\u6BCF\u4E2A npm \u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u540E\u7684\u91CD\u8BD5\u6B21\u6570\u3002", concurrency: "\u6279\u91CF\u83B7\u53D6\u4F9D\u8D56\u7248\u672C\u65F6\u7684\u6700\u5927\u5E76\u53D1\u6570\u3002", installLogRetentionHours: "\u4F9D\u8D56\u5B89\u88C5\u3001\u66F4\u65B0\u4E0E\u5378\u8F7D\u64CD\u4F5C\u65E5\u5FD7\u4FDD\u7559\u591A\u5C11\u5C0F\u65F6\uFF0C\u9ED8\u8BA4 72 \u5C0F\u65F6\u3002" }, search: { $description: "\u641C\u7D22\u8BBE\u7F6E", endpoint: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u7F51\u5740\u3002\u9ED8\u8BA4\u4F7F\u7528 t4wefan \u955C\u50CF\u3002", timeout: "\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u8D85\u65F6\u65F6\u95F4\u3002", proxyAgent: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u4EE3\u7406\u3002", autoRoute: "\u5F53\u524D\u5E02\u573A\u6E90\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528\u5E02\u573A\u6E90\u3002", logLevel: "\u63D2\u4EF6\u5E02\u573A\u8C03\u8BD5\u65E5\u5FD7\u7EA7\u522B\u3002silent \u5173\u95ED\u65E5\u5FD7\uFF0Cdebug \u8F93\u51FA\u6700\u8BE6\u7EC6\u3002" }, frontendMode: "\u524D\u7AEF\u663E\u793A\u6A21\u5F0F\u3002\u6027\u80FD\u6A21\u5F0F\u4FDD\u6301\u4F4E\u52A8\u6548\uFF1B\u7CBE\u81F4\u6A21\u5F0F\u542F\u7528\u66F4\u7EC6\u817B\u7684\u52A8\u6548\u548C\u9AD8\u7EA7\u6837\u5F0F\u3002", depsLayout: "\u4F9D\u8D56\u7BA1\u7406\u9875\u5E03\u5C40\u3002\u7F51\u683C\u6A21\u5F0F\u591A\u5217\u5C55\u793A\uFF1B\u5217\u8868\u6A21\u5F0F\u5355\u5217\u5BBD\u5361\u7247\uFF0C\u4FE1\u606F\u66F4\u5BC6\u96C6\u3002", marketLayout: "\u63D2\u4EF6\u5E02\u573A\u9875\u5E03\u5C40\u3002\u7F51\u683C\u6A21\u5F0F\u591A\u5217\u5361\u7247\uFF1B\u5217\u8868\u6A21\u5F0F\u5355\u5217\u7D27\u51D1\u884C\u3002", marketSilentRules: "\u63D2\u4EF6\u5E02\u573A\u6C38\u4E45\u9759\u9ED8\u8FC7\u6EE4\u3002\u6DFB\u52A0\u540E\u547D\u4E2D\u7684\u63D2\u4EF6\u4F1A\u76F4\u63A5\u9690\u85CF\uFF0C\u4E0D\u4F1A\u663E\u793A\u5728\u641C\u7D22\u6846\u4E2D\u3002\u72B6\u6001\u7C7B\u4E0D\u9700\u8981\u586B\u5199\u503C\uFF1B\u65E5\u671F\u7C7B\u586B\u5199 YYYY-MM-DD\uFF1B\u6700\u8FD1 N \u5929\u586B\u5199\u6570\u5B57\u3002", marketSilentFilters: "\u65E7\u7248\u6C38\u4E45\u9759\u9ED8\u8FC7\u6EE4\u3002", idleProbe: "Console \u7A7A\u95F2\u65F6\u81EA\u52A8\u63A2\u6D4B\u4F9D\u8D56\u7248\u672C\u548C\u63D2\u4EF6\u5E02\u573A\u6570\u636E\u3002\u4EC5\u5728\u6CA1\u6709\u6D4F\u89C8\u5668\u63A7\u5236\u53F0\u8FDE\u63A5\u65F6\u8FD0\u884C\uFF0C\u4E0D\u4F1A\u56E0\u4E3A\u5237\u65B0\u9875\u9762\u89E6\u53D1\u3002", idleProbeDelay: "Console \u65E0\u4EBA\u5728\u7EBF\u591A\u4E45\u540E\u5F00\u59CB\u540E\u53F0\u63A2\u6D4B\u3002", idleProbeBootDelay: "Koishi \u542F\u52A8\u6216\u91CD\u8F7D\u540E\uFF0C\u81F3\u5C11\u7B49\u5F85\u591A\u4E45\u624D\u5141\u8BB8\u7A7A\u95F2\u63A2\u6D4B\u3002", idleProbeInterval: "\u4E24\u6B21\u7A7A\u95F2\u540E\u53F0\u63A2\u6D4B\u4E4B\u95F4\u7684\u6700\u5C0F\u95F4\u9694\u3002", bulkMode: "\u6279\u91CF\u64CD\u4F5C\u6A21\u5F0F\u3002\u5F00\u542F\u540E\u5B89\u88C5\u3001\u66F4\u65B0\u3001\u5378\u8F7D\u4F1A\u5148\u6682\u5B58\uFF0C\u70B9\u51FB\u201C\u5E94\u7528\u66F4\u6539\u201D\u540E\u6267\u884C\u3002", removeConfig: "\u5378\u8F7D\u63D2\u4EF6\u65F6\u662F\u5426\u540C\u65F6\u5220\u9664\u5DF2\u6709\u63D2\u4EF6\u914D\u7F6E\u3002\u672A\u8BBE\u7F6E\u65F6\u6BCF\u6B21\u8BE2\u95EE\u3002", updateIgnoredPackages: "\u4E0D\u68C0\u6D4B\u66F4\u65B0\u7684\u4F9D\u8D56\u540D\u3002\u6BCF\u884C\u4E00\u4E2A\u5305\u540D\uFF0C\u4E5F\u53EF\u4EE5\u4F7F\u7528\u9017\u53F7\u3001\u5206\u53F7\u6216\u7A7A\u683C\u5206\u9694\u3002", updateIgnoreDuration: "\u70B9\u51FB\u201C\u5FFD\u7565\u6B64\u6B21\u66F4\u65B0\u201D\u540E\u7684\u9ED8\u8BA4\u5FFD\u7565\u65F6\u957F\u30020 \u8868\u793A\u4E0D\u6309\u65F6\u95F4\u8FC7\u671F\u3002", updateIgnoreVersions: "\u70B9\u51FB\u201C\u5FFD\u7565\u6B64\u6B21\u66F4\u65B0\u201D\u540E\u8FDE\u7EED\u5FFD\u7565\u51E0\u4E2A\u65B0\u7248\u672C\u30021 \u8868\u793A\u53EA\u5FFD\u7565\u5F53\u524D\u6700\u65B0\u7248\u672C\u3002", updateIgnorePrerelease: "\u624B\u52A8\u5F00\u542F\u540E\uFF0Calpha / beta / rc \u7B49\u9884\u53D1\u5E03\u7248\u672C\u4E0D\u4F1A\u88AB\u89C6\u4E3A\u53EF\u66F4\u65B0\u7248\u672C\u3002", chatlunaTool: "\u542F\u7528 ChatLuna \u63D2\u4EF6\u5E02\u573A\u67E5\u8BE2\u5DE5\u5177\u3002\u542F\u7528\u540E\uFF0C\u82E5\u5F53\u524D Koishi \u540C\u65F6\u5B89\u88C5\u4E86 ChatLuna\uFF0C\u4F1A\u6CE8\u518C\u53EA\u8BFB\u5DE5\u5177 koishi_plugin_market_search\u3002" };
  }
});
...
var Installer = class extends import_koishi.Service {
  constructor(ctx, config = {}) {
    ...
    this.statsFile = (0, import_path2.resolve)(ctx.baseDir, "cache", "market-next-registry-stats.json");
    ctx.effect(() => () => {
  ...
  async loadRouteStats() {
    try {
      const content = await import_fs2.promises.readFile(this.statsFile, "utf8");
  ...
  scheduleStatsWrite() {
    ...
    this.statsWriteTimer = setTimeout(async () => {
      ...
      try {
        await import_fs2.promises.mkdir((0, import_path2.resolve)(this.statsFile, ".."), { recursive: true });
        await import_fs2.promises.writeFile(this.statsFile, JSON.stringify({ version: 1, stats, savedAt: Date.now() }));
      } catch (error) {
  ...
  getInstallLogDir() {
    return (0, import_path2.resolve)(this.cwd, "data", INSTALL_LOG_DIR);
  }
    ...
    this.installLogCleanupTask = (async () => {
      ...
      try {
        ...
        await Promise.all(entries.filter((entry) => entry.isFile() && (entry.name.endsWith(".log") || entry.name.endsWith(".log.json"))).map(async (entry) => {
          const path = (0, import_path2.resolve)(dir, entry.name);
  ...
  async writeInstallLogMetadata() {
    ...
    await import_fs2.promises.writeFile(this.installLogMetadataFile, JSON.stringify(this.installLogMetadata, null, 2) + "\n");
  }
  async startInstallLog(deps, forced, options = {}, changes = []) {
    ...
    const file = (0, import_path2.resolve)(dir, `${formatLogTimestamp(now)}-${suffix}.log`);
    const id = (0, import_path2.basename)(file);
    await import_fs2.promises.writeFile(file, [
...
`;
    this.installLogWriteTask = this.installLogWriteTask.then(() => import_fs2.promises.appendFile(file, text)).catch((error) => {
  ...
  getInstallLogPath(id) {
    if (!id || (0, import_path2.basename)(id) !== id || !id.endsWith(".log")) return;
    return (0, import_path2.resolve)(this.getInstallLogDir(), id);
  }
  async readInstallLogMetadata(id) {
    const file = this.getInstallLogPath(id);
    if (!file) return;
    try {
      const metadata = JSON.parse(await import_fs2.promises.readFile(file + ".json", "utf8"));
  ...
  async readInstallLog(file, limit, headLimit, tailLimit) {
    ...
    if (stat.size <= limit) {
      return {
        content: await import_fs2.promises.readFile(file, "utf8"),
        truncated: false,
        size: stat.size
      };
    }
    const handle = await import_fs2.promises.open(file, "r");
    try {
...
${tail.toString("utf8")}`,
  ...
  parseLegacyInstallLog(id, content, size) {
    ...
    const active = (0, import_path2.basename)(this.installLogFile || "") === id;
  ...
  getRollbackChanges(metadata) {
    if (metadata.changes.some((change) => !change.beforeRequest || !change.afterRequest)) return [];
    return metadata.changes.filter((change) => change.beforeResolved && change.afterResolved && change.beforeResolved !== change.afterResolved);
  }
  getInstalledHistoryVersion(name2, cache2) {
    if (cache2.has(name2)) return cache2.get(name2);
    let version = null;
    try {
      version = loadManifest(name2).version;
    } catch {
    }
    cache2.set(name2, version);
    return version;
  }
  assessInstallRollback(metadata, currentDependencies, resolvedCache = /* @__PURE__ */ new Map()) {
    const active = (0, import_path2.basename)(this.installLogFile || "") === metadata.id;
    if (active) return "running";
    if (metadata.status !== "success") return "not-successful";
    if (!metadata.changes.length) return "legacy";
    const changes = this.getRollbackChanges(metadata);
    if (!changes.length) return "unsupported";
    if (!currentDependencies) return "state-changed";
    for (const change of changes) {
      const currentRequest = Object.prototype.hasOwnProperty.call(currentDependencies, change.name) ? currentDependencies[change.name] : null;
      if (currentRequest !== change.afterRequest) return "state-changed";
      if (this.getInstalledHistoryVersion(change.name, resolvedCache) !== change.afterResolved) return "state-changed";
    }
  }
  createInstallHistoryEntry(metadata, size, currentDependencies, resolvedCache) {
    const rollbackReason = this.assessInstallRollback(metadata, currentDependencies, resolvedCache);
    const status = metadata.status === "running" && (0, import_path2.basename)(this.installLogFile || "") !== metadata.id ? "unknown" : metadata.status;
    return {
      id: metadata.id,
  ...
  async getInstallHistoryEntry(id, currentDependencies, resolvedCache) {
    const file = this.getInstallLogPath(id);
    if (!file) return;
    if (file === this.installLogFile) await this.installLogWriteTask;
    let stat;
    try {
      stat = await import_fs2.promises.stat(file);
    } catch (error) {
  ...
  async getInstallHistory(limit = 20) {
    ...
    try {
      ...
      files = (await Promise.all(entries.filter((entry) => entry.isFile() && entry.name.endsWith(".log")).map(async (entry) => ({
        id: entry.name,
        mtime: (await import_fs2.promises.stat((0, import_path2.resolve)(dir, entry.name))).mtimeMs
      })))).sort((a, b) => b.mtime - a.mtime).slice(0, count);
    } catch (error) {
      if (error?.code === "ENOENT") return [];
      throw error;
    }
    const currentDependencies = await this.snapshotPackageManifest().then((snapshot) => snapshot.dependencies).catch(() => void 0);
  ...
  async override(deps) {
    const filename = (0, import_path2.resolve)(this.cwd, "package.json");
  ...
  async snapshotPackageManifest() {
    const filename = (0, import_path2.resolve)(this.cwd, "package.json");
    const content = await import_fs2.promises.readFile(filename, "utf8");
  ...
  async restorePackageManifest(snapshot, deps, reason) {
    ...
    let manifest;
    try {
      manifest = JSON.parse(await import_fs2.promises.readFile(filename, "utf8"));
    } catch {
    ...
    await import_fs2.promises.writeFile(filename, JSON.stringify(manifest, null, 2) + "\n");
  ...
  validateInstallHistoryState(snapshot, localDeps, expectedChanges) {
    for (const change of expectedChanges) {
      const currentRequest = Object.prototype.hasOwnProperty.call(snapshot.dependencies, change.name) ? snapshot.dependencies[change.name] : null;
  ...
  async _installLocked(deps, forced, beforeReload, options = {}, expectedChanges = []) {
    options ||= {};
    const start = Date.now();
    let resultCode;
    let logResult;
  ...
  async queueInstall(deps, forced, beforeReload, options = {}, expectedChanges = []) {
    options ||= {};
  ...
  async rollbackInstallHistory(id, beforeReload, options = {}) {
    const metadata = await this.readInstallLogMetadata(id);
...
function formatRollbackError(reason) {
  switch (reason) {
    case "running":
      return "\u8BE5\u4F9D\u8D56\u64CD\u4F5C\u4ECD\u5728\u6267\u884C\uFF0C\u6682\u65F6\u4E0D\u80FD\u56DE\u9000\u3002";
    case "not-successful":
      return "\u53EA\u6709\u6210\u529F\u5B8C\u6210\u7684\u4F9D\u8D56\u66F4\u65B0\u624D\u80FD\u56DE\u9000\u3002";
    case "legacy":
      return "\u65E7\u7248\u65E5\u5FD7\u6CA1\u6709\u4FDD\u5B58\u56DE\u9000\u6240\u9700\u7684\u7248\u672C\u4FE1\u606F\u3002";
    case "unsupported":
      return "\u65B0\u589E\u5B89\u88C5\u3001\u5378\u8F7D\u6216\u672A\u6539\u53D8\u7248\u672C\u7684\u64CD\u4F5C\u4E0D\u652F\u6301\u4E00\u952E\u56DE\u9000\u3002";
    case "state-changed":
      return "\u4F9D\u8D56\u72B6\u6001\u5DF2\u5728\u8BE5\u64CD\u4F5C\u540E\u53D1\u751F\u53D8\u5316\uFF0C\u4E3A\u907F\u514D\u8986\u76D6\u540E\u7EED\u4FEE\u6539\uFF0C\u5DF2\u53D6\u6D88\u56DE\u9000\u3002";
    default:
      return "\u8BE5\u64CD\u4F5C\u5F53\u524D\u4E0D\u80FD\u56DE\u9000\u3002";
  }
}
...
function validateBundleManifest(packageName, bundle, options = {}) {
  ...
  for (const [index, member] of bundle.members.entries()) {
    ...
    else if (!(0, import_semver2.validRange)(member.version.trim())) errors.push(`${prefix}.version is not a valid semver range`);
...
var MarketProvider2 = class extends MarketProvider {
  constructor(ctx, config = {}) {
    ...
    this.cacheFile = (0, import_path3.resolve)(ctx.baseDir, "cache", "market-next-index.json");
    this.cacheDir = (0, import_path3.resolve)(ctx.baseDir, "cache", "market-next-index");
  ...
  async loadDiskCache(serial) {
    ...
    try {
      ...
      const content = await import_fs3.promises.readFile(this.cacheFile, "utf8");
  ...
  async loadCacheEntryResult(entry) {
    ...
    try {
      const content = await import_fs3.promises.readFile((0, import_path3.resolve)(this.cacheDir, entry.file), "utf8");
  ...
  getCacheEntryFilename(endpoint) {
    return `${(0, import_crypto.createHash)("sha1").update(endpoint).digest("hex").slice(0, 16)}.json`;
  }
  ...
  async writeCacheEntryFile(entry) {
    await import_fs3.promises.mkdir(this.cacheDir, { recursive: true });
    const file = (0, import_path3.resolve)(this.cacheDir, this.getCacheEntryFilename(entry.endpoint));
    const tempFile = `${file}.${process.pid}.${Date.now()}.tmp`;
    await import_fs3.promises.writeFile(tempFile, JSON.stringify(entry.result));
    await import_fs3.promises.rename(tempFile, file);
  }
  async pruneSplitCacheFiles(entries) {
    try {
      const keep = new Set(Object.values(entries).map((entry) => entry?.file).filter(Boolean));
      const files = await import_fs3.promises.readdir(this.cacheDir).catch(() => []);
      await Promise.all(files.filter((file) => file.endsWith(".json") && !keep.has(file)).map((file) => import_fs3.promises.unlink((0, import_path3.resolve)(this.cacheDir, file)).catch(() => {
      })));
    } catch (error) {
  ...
  async writeDiskCache(cache2) {
    if (this.disposed || !this.ctx.scope.isActive) return;
    try {
      await import_fs3.promises.mkdir((0, import_path3.dirname)(this.cacheFile), { recursive: true });
      const entries = {};
      ...
      await import_fs3.promises.writeFile(tempFile, nextStore);
      await import_fs3.promises.rename(tempFile, this.cacheFile);
...
function getAvatarCacheDir(ctx) {
  return (0, import_path4.resolve)(ctx.baseDir, "cache", "market-next-avatars");
}
function normalizeAvatarCacheKey(key) {
  return key.replace(/[^0-9A-Za-z:@._-]/g, "-").slice(0, 128) || `url:${(0, import_crypto2.createHash)("sha1").update(key).digest("hex")}`;
}
function getAvatarCacheFile(ctx, key) {
  return (0, import_path4.resolve)(getAvatarCacheDir(ctx), `${(0, import_crypto2.createHash)("sha1").update(normalizeAvatarCacheKey(key)).digest("hex")}.json`);
}
...
async function readAvatarDiskCache(ctx, key) {
  try {
    ...
    const entry = normalizeAvatarDiskCache(JSON.parse(await import_fs4.promises.readFile(file, "utf8")), key);
    if (!entry) {
      void import_fs4.promises.unlink(file).catch(() => {
      });
      return;
    }
...
async function writeAvatarDiskCache(ctx, key, url, result) {
  try {
    await import_fs4.promises.mkdir(getAvatarCacheDir(ctx), { recursive: true });
    const file = getAvatarCacheFile(ctx, key);
    const tempFile = `${file}.${process.pid}.${Date.now()}.tmp`;
    const entry = {
      key,
    ...
    await import_fs4.promises.writeFile(tempFile, JSON.stringify(entry));
...
async function cleanupAvatarDiskCache(ctx) {
  ...
  avatarDiskCleanupTask = (async () => {
    try {
      ...
      await Promise.all(alive.slice(AVATAR_MAX_ENTRIES).map((entry) => import_fs4.promises.unlink(entry.path).catch(() => {
      })));
    } finally {
...
async function clearAvatarCacheStorage(ctx) {
  ...
  const dir = getAvatarCacheDir(ctx);
  const files = await import_fs4.promises.readdir(dir).catch((error) => {
    if (error?.code === "ENOENT") return [];
    throw error;
  });
  const disk = files.filter((file) => file.endsWith(".json")).length;
  await import_fs4.promises.rm(dir, { recursive: true, force: true });
  return { memory, disk };
}
...
async function assertNoDirectBundleCycles(ctx, packageName, members) {
  ...
  for (const member of members) {
    try {
      ...
      const version = (0, import_semver3.maxSatisfying)(versions, member.version, { includePrerelease: true });
      if (!version) continue;
...
function apply(ctx, config = {}) {
  ...
  ctx.inject(["installer"], (ctx2) => {
    ...
    ctx2.command("plugin.upgrade [name...]", { authority: 4 }).alias(".update", ".up").option("self", "-s, --koishi").action(async ({ session, options }, ...names) => {
      ...
      names = names.filter((name2) => {
        ...
        try {
          return !invalid && (0, import_semver3.gt)(latest, resolved);
        } catch {
        }
      });
  ...
  ctx.inject(["console", "installer"], (ctx2) => {
    ...
    ctx2.console.addListener("market/install-history-rollback", async (id, options) => {
      const record = await ctx2.installer.getInstallLogDetail(id);
      const installNames = (record?.changes ?? []).map((change) => change.name).filter((name2) => name2 !== SELF_PACKAGE2);
      const code = await ctx2.installer.rollbackInstallHistory(id, installNames.length ? () => ensurePluginConfigs(ctx2, installNames) : void 0, options);
      if (!code) await ensurePluginConfigs(ctx2, installNames);
      await Promise.all([
        ctx2.get("console")?.refresh("dependencies"),
        ctx2.get("console")?.refresh("registry"),
        ctx2.get("console")?.refresh("packages"),
