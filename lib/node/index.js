...
var require_schema_zh_CN = __commonJS({
  "src/node/locales/schema.zh-CN.yml"(exports2, module2) {
    module2.exports = { registry: { $description: "\u63D2\u4EF6\u6E90\u8BBE\u7F6E", endpoint: "\u63D2\u4EF6\u7684\u4E0B\u8F7D\u6E90\u3002\u9ED8\u8BA4\u8DDF\u968F\u5F53\u524D\u9879\u76EE\u7684 npm config\u3002", timeout: "\u83B7\u53D6\u63D2\u4EF6\u6570\u636E\u7684\u8D85\u65F6\u65F6\u95F4\u3002", autoRoute: "\u5F53\u524D\u4E0B\u8F7D\u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528 npm \u6E90\u3002", retry: "\u6BCF\u4E2A npm \u6E90\u83B7\u53D6\u7248\u672C\u5931\u8D25\u540E\u7684\u91CD\u8BD5\u6B21\u6570\u3002", concurrency: "\u6279\u91CF\u83B7\u53D6\u4F9D\u8D56\u7248\u672C\u65F6\u7684\u6700\u5927\u5E76\u53D1\u6570\u3002" }, search: { $description: "\u641C\u7D22\u8BBE\u7F6E", endpoint: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u7F51\u5740\u3002\u9ED8\u8BA4\u4F7F\u7528 t4wefan \u955C\u50CF\u3002", timeout: "\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u8D85\u65F6\u65F6\u95F4\u3002", proxyAgent: "\u7528\u4E8E\u641C\u7D22\u63D2\u4EF6\u5E02\u573A\u7684\u4EE3\u7406\u3002", autoRoute: "\u5F53\u524D\u5E02\u573A\u6E90\u5931\u8D25\u65F6\u81EA\u52A8\u5C1D\u8BD5\u5907\u7528\u5E02\u573A\u6E90\u3002", logLevel: "\u63D2\u4EF6\u5E02\u573A\u8C03\u8BD5\u65E5\u5FD7\u7EA7\u522B\u3002silent \u5173\u95ED\u65E5\u5FD7\uFF0Cdebug \u8F93\u51FA\u6700\u8BE6\u7EC6\u3002" }, frontendMode: "\u524D\u7AEF\u663E\u793A\u6A21\u5F0F\u3002\u6027\u80FD\u6A21\u5F0F\u4FDD\u6301\u4F4E\u52A8\u6548\uFF1B\u7CBE\u81F4\u6A21\u5F0F\u542F\u7528\u66F4\u7EC6\u817B\u7684\u52A8\u6548\u548C\u9AD8\u7EA7\u6837\u5F0F\u3002", depsLayout: "\u4F9D\u8D56\u7BA1\u7406\u9875\u5E03\u5C40\u3002\u7F51\u683C\u6A21\u5F0F\u591A\u5217\u5C55\u793A\uFF1B\u5217\u8868\u6A21\u5F0F\u5355\u5217\u5BBD\u5361\u7247\uFF0C\u4FE1\u606F\u66F4\u5BC6\u96C6\u3002", marketLayout: "\u63D2\u4EF6\u5E02\u573A\u9875\u5E03\u5C40\u3002\u7F51\u683C\u6A21\u5F0F\u591A\u5217\u5361\u7247\uFF1B\u5217\u8868\u6A21\u5F0F\u5355\u5217\u7D27\u51D1\u884C\u3002", marketSilentRules: "\u63D2\u4EF6\u5E02\u573A\u6C38\u4E45\u9759\u9ED8\u8FC7\u6EE4\u3002\u6DFB\u52A0\u540E\u547D\u4E2D\u7684\u63D2\u4EF6\u4F1A\u76F4\u63A5\u9690\u85CF\uFF0C\u4E0D\u4F1A\u663E\u793A\u5728\u641C\u7D22\u6846\u4E2D\u3002\u72B6\u6001\u7C7B\u4E0D\u9700\u8981\u586B\u5199\u503C\uFF1B\u65E5\u671F\u7C7B\u586B\u5199 YYYY-MM-DD\uFF1B\u6700\u8FD1 N \u5929\u586B\u5199\u6570\u5B57\u3002", marketSilentFilters: "\u65E7\u7248\u6C38\u4E45\u9759\u9ED8\u8FC7\u6EE4\u3002", idleProbe: "Console \u7A7A\u95F2\u65F6\u81EA\u52A8\u63A2\u6D4B\u4F9D\u8D56\u7248\u672C\u548C\u63D2\u4EF6\u5E02\u573A\u6570\u636E\u3002\u4EC5\u5728\u6CA1\u6709\u6D4F\u89C8\u5668\u63A7\u5236\u53F0\u8FDE\u63A5\u65F6\u8FD0\u884C\uFF0C\u4E0D\u4F1A\u56E0\u4E3A\u5237\u65B0\u9875\u9762\u89E6\u53D1\u3002", idleProbeDelay: "Console \u65E0\u4EBA\u5728\u7EBF\u591A\u4E45\u540E\u5F00\u59CB\u540E\u53F0\u63A2\u6D4B\u3002", idleProbeBootDelay: "Koishi \u542F\u52A8\u6216\u91CD\u8F7D\u540E\uFF0C\u81F3\u5C11\u7B49\u5F85\u591A\u4E45\u624D\u5141\u8BB8\u7A7A\u95F2\u63A2\u6D4B\u3002", idleProbeInterval: "\u4E24\u6B21\u7A7A\u95F2\u540E\u53F0\u63A2\u6D4B\u4E4B\u95F4\u7684\u6700\u5C0F\u95F4\u9694\u3002", bulkMode: "\u6279\u91CF\u64CD\u4F5C\u6A21\u5F0F\u3002\u5F00\u542F\u540E\u5B89\u88C5\u3001\u66F4\u65B0\u3001\u5378\u8F7D\u4F1A\u5148\u6682\u5B58\uFF0C\u70B9\u51FB\u201C\u5E94\u7528\u66F4\u6539\u201D\u540E\u6267\u884C\u3002", removeConfig: "\u5378\u8F7D\u63D2\u4EF6\u65F6\u662F\u5426\u540C\u65F6\u5220\u9664\u5DF2\u6709\u63D2\u4EF6\u914D\u7F6E\u3002\u672A\u8BBE\u7F6E\u65F6\u6BCF\u6B21\u8BE2\u95EE\u3002", updateIgnoredPackages: "\u4E0D\u68C0\u6D4B\u66F4\u65B0\u7684\u4F9D\u8D56\u540D\u3002\u6BCF\u884C\u4E00\u4E2A\u5305\u540D\uFF0C\u4E5F\u53EF\u4EE5\u4F7F\u7528\u9017\u53F7\u3001\u5206\u53F7\u6216\u7A7A\u683C\u5206\u9694\u3002", updateIgnoreDuration: "\u70B9\u51FB\u201C\u5FFD\u7565\u6B64\u6B21\u66F4\u65B0\u201D\u540E\u7684\u9ED8\u8BA4\u5FFD\u7565\u65F6\u957F\u30020 \u8868\u793A\u4E0D\u6309\u65F6\u95F4\u8FC7\u671F\u3002", updateIgnoreVersions: "\u70B9\u51FB\u201C\u5FFD\u7565\u6B64\u6B21\u66F4\u65B0\u201D\u540E\u8FDE\u7EED\u5FFD\u7565\u51E0\u4E2A\u65B0\u7248\u672C\u30021 \u8868\u793A\u53EA\u5FFD\u7565\u5F53\u524D\u6700\u65B0\u7248\u672C\u3002", updateIgnorePrerelease: "\u624B\u52A8\u5F00\u542F\u540E\uFF0Calpha / beta / rc \u7B49\u9884\u53D1\u5E03\u7248\u672C\u4E0D\u4F1A\u88AB\u89C6\u4E3A\u53EF\u66F4\u65B0\u7248\u672C\u3002", chatlunaTool: "\u542F\u7528 ChatLuna \u63D2\u4EF6\u5E02\u573A\u67E5\u8BE2\u5DE5\u5177\u3002\u542F\u7528\u540E\uFF0C\u82E5\u5F53\u524D Koishi \u540C\u65F6\u5B89\u88C5\u4E86 ChatLuna\uFF0C\u4F1A\u6CE8\u518C\u53EA\u8BFB\u5DE5\u5177 koishi_plugin_market_search\u3002" };
  }
});
...
var MarketDataStore = class extends import_console2.DataService {
  ...
  async patch(patch) {
    await this.ready;
    let changed = false;
    for (const key of ["override", "updateIgnored", "bundleRecords"]) {
  ...
  async exec(args) {
    ...
    return new Promise((resolve6) => {
      ...
      this.ctx.get("console")?.broadcast("market/install-log", {
        type: "stdout",
        line: `package manager started: agent=${name2}${this.agent?.version ? "@" + this.agent.version : ""}`
      });
      child.on("exit", (code) => {
      ...
      child.stdout.on("data", (data) => {
        ...
        for (const line of lines) {
          ...
          try {
            ...
            this.ctx.get("console")?.broadcast("market/install-log", { type: "stdout", line: data2 });
          } catch (error) {
            logger.warn(line);
            logger.warn(error);
            this.ctx.get("console")?.broadcast("market/install-log", { type: "stderr", line });
...
var SOURCE_EXTENSIONS = /* @__PURE__ */ new Set([".js", ".cjs", ".mjs", ".ts", ".tsx", ".jsx"]);
var MAX_SOURCE_FILES = 220;
var MAX_SOURCE_FILE_SIZE = 512 * 1024;
var MAX_SOURCE_TOTAL_SIZE = 3 * 1024 * 1024;
var MAX_DIRECTORY_ENTRIES = 2500;
var MAX_RESULT_ITEMS = 24;
async function analyzePluginResidue(ctx, names) {
  const unique2 = Array.from(new Set(names.filter(Boolean))).slice(0, 20);
  return Promise.all(unique2.map((name2) => analyzeOnePluginResidue(ctx, name2)));
}
async function removeResiduePaths(ctx, paths) {
  const result = { removed: [], failed: [] };
  for (const path of Array.from(new Set(paths.filter(Boolean))).slice(0, 50)) {
    try {
      const target = (0, import_path4.resolve)(ctx.baseDir, path);
      if (!isSafeResiduePath(ctx, target)) {
        result.failed.push({ path, error: "path is outside allowed data/cache directories" });
        continue;
      }
      await import_fs4.promises.rm(target, { recursive: true, force: true });
      result.removed.push(target);
    } catch (error) {
      result.failed.push({ path, error: formatError3(error) });
    }
  }
  return result;
}
async function analyzeOnePluginResidue(ctx, name2) {
  const packageRoot = resolvePackageRoot(name2);
  ...
  const pathHints = Array.from(/* @__PURE__ */ new Set([
    ...getNamePathHints(name2),
    ...source.sourcePaths
...
function resolvePackageRoot(name2) {
  try {
    return (0, import_path4.dirname)(require.resolve(`${name2}/package.json`));
  } catch {
  }
}
function getNamePathHints(name2) {
  const keys = getPackageKeys(name2);
  return keys.flatMap((key) => [`data/${key}`, `cache/${key}`]);
}
function getPackageKeys(name2) {
  const parts = name2.split("/");
  const unscoped = parts[parts.length - 1];
  const withoutPrefix = unscoped.replace(/^koishi-plugin-/, "").replace(/^plugin-/, "");
  const scopedShort = name2.startsWith("@") ? `${name2.split("/")[0].slice(1)}-${withoutPrefix}` : "";
  return Array.from(new Set([
    sanitizePathKey(name2),
...
function sanitizePathKey(value) {
  return value.toLowerCase().replace(/^@/, "").replace(/[^0-9a-z._-]+/g, "-").replace(/^-+|-+$/g, "").slice(0, 96);
}
async function scanPackageSource(packageRoot) {
  ...
  for (const file of files) {
    const stat = await import_fs4.promises.stat(file).catch(() => void 0);
    ...
    totalSize += stat.size;
    const content = await import_fs4.promises.readFile(file, "utf8").catch(() => "");
...
async function collectSourceFiles(root) {
  ...
  while (stack.length && result.length < MAX_SOURCE_FILES) {
    const dir = stack.pop();
    const entries = await import_fs4.promises.readdir(dir, { withFileTypes: true }).catch(() => []);
...
function collectMatches(target, content, patterns, filter) {
...
function collectPathHints(target, content) {
  const patterns = [
...
function normalizeRelativeHint(value) {
  const normalized = value.replace(/\\/g, "/").replace(/^\.?\//, "").replace(/\/+/g, "/");
  if (!/^(data|cache)\//.test(normalized)) return "";
  if (normalized.includes("${") || normalized.includes("..")) return "";
  return normalized.split("/").slice(0, 4).join("/");
}
function isCleanupCommand(value) {
  return /(?:wipe|purge|clean|clear|reset|migrate|legacy|delete|remove)/i.test(value);
}
async function getExistingResidueDirectories(ctx, hints, sourceHints) {
  const sourceSet = new Set(sourceHints);
  const directories = [];
  for (const hint of hints) {
    const target = (0, import_path4.resolve)(ctx.baseDir, hint);
    if (!isSafeResiduePath(ctx, target)) continue;
    const stats = await getPathStats(target);
    if (!stats) continue;
    directories.push({
      path: target,
      relative: (0, import_path4.relative)(ctx.baseDir, target).replace(/\\/g, "/"),
      source: sourceSet.has(hint) ? "source" : "name",
      removable: true,
      ...stats
    });
  }
  return uniqueDirectories(directories).sort((a, b) => b.size - a.size).slice(0, MAX_RESULT_ITEMS);
}
async function getPathStats(path) {
  const stat = await import_fs4.promises.stat(path).catch(() => void 0);
  if (!stat) return;
  if (!stat.isDirectory()) {
  ...
  while (stack.length) {
    ...
    const entries = await import_fs4.promises.readdir(dir, { withFileTypes: true }).catch(() => []);
    for (const entry of entries) {
      const child = (0, import_path4.resolve)(dir, entry.name);
      const childStat = await import_fs4.promises.stat(child).catch(() => void 0);
...
function isSafeResiduePath(ctx, path) {
  const base = (0, import_path4.resolve)(ctx.baseDir);
  const allowedRoots = [(0, import_path4.resolve)(base, "data"), (0, import_path4.resolve)(base, "cache")];
  if (!(0, import_path4.isAbsolute)(path)) return false;
  const root = allowedRoots.find((root2) => isInside(path, root2));
  if (!root) return false;
  if (path === root) return false;
  const nested = (0, import_path4.relative)(root, path).split(import_path4.sep).filter(Boolean);
  if (!nested.length) return false;
  if (nested.some((part) => part === "..")) return false;
  return true;
}
function isInside(path, root) {
  const rel = (0, import_path4.relative)(root, path);
  return rel === "" || !!rel && !rel.startsWith("..") && !(0, import_path4.isAbsolute)(rel);
}
...
function getAvatarCacheFile(ctx, key) {
  return (0, import_path5.resolve)(getAvatarCacheDir(ctx), `${(0, import_crypto2.createHash)("sha1").update(normalizeAvatarCacheKey(key)).digest("hex")}.json`);
}
...
async function updateMarketNextConfig(ctx, currentConfig, patch) {
  ...
  for (const key of configPatchKeys) {
    if (!Object.prototype.hasOwnProperty.call(patch, key)) continue;
    target.value[key] = key === "marketSilentRules" ? normalizeMarketSilentRules(patch[key]) : patch[key];
    changed = true;
  }
...
function apply(ctx, config = {}) {
  ...
  ctx.inject(["console", "installer"], (ctx2) => {
    ...
    ctx2.console.addListener("market/analyze-residue", async (names) => {
      return analyzePluginResidue(ctx2, names);
    }, { authority: 4 });
    ctx2.console.addListener("market/remove-residue-paths", async (paths) => {
      return removeResiduePaths(ctx2, paths);
    }, { authority: 4 });
    ctx2.on("ready", () => {
